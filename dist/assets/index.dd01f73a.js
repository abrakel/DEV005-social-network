    ...
    querySnapshot.forEach((doc) => {
      ...
      btnsDelete.forEach((btnDelete) => {
        btnDelete.addEventListener("click", async (e) => {
          ...
          modalText.innerText = "\xBFEst\xE1 seguro de que desea eliminar esta publicaci\xF3n?";
          ...
          modalContent2.appendChild(modalText);
          modalContent2.appendChild(modalButtons);
