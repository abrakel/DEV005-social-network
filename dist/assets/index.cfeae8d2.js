...
function ha(a, b2, c) {
  ...
  if (2 < arguments.length) {
    ...
    return function() {
      ...
      Array.prototype.unshift.apply(e2, d);
      return a.apply(b2, e2);
    };
  }
  return function() {
...
function oa$1(a, b2) {
  for (let c = 1; c < arguments.length; c++) {
    const d = arguments[c];
    if (ba(d)) {
      const e2 = a.length || 0, f = d.length || 0;
      a.length = e2 + f;
      for (let h = 0; h < f; h++)
        a[e2 + h] = d[h];
    } else
...
var wa = x("Opera"), y = x("Trident") || x("MSIE"), xa$1 = x("Edge"), ya = xa$1 || y, za$1 = x("Gecko") && !(-1 != ta$1().toLowerCase().indexOf("webkit") && !x("Edge")) && !(x("Trident") || x("MSIE")) && !x("Edge"), Aa = -1 != ta$1().toLowerCase().indexOf("webkit") && !x("Edge");
function Ba() {
  var a = l.document;
  ...
  return va(Ga, 9, function() {
    ...
    for (let h = 0; 0 == a && h < d; h++) {
      ...
      do {
        e2 = /(\d*)(\D*)(.*)/.exec(e2) || ["", "", "", ""];
        f = /(\d*)(\D*)(.*)/.exec(f) || ["", "", "", ""];
        if (0 == e2[0].length && 0 == f[0].length)
          break;
        a = sa$1(0 == e2[1].length ? 0 : parseInt(e2[1], 10), 0 == f[1].length ? 0 : parseInt(f[1], 10)) || sa$1(0 == e2[2].length, 0 == f[2].length) || sa$1(e2[2], f[2]);
        e2 = e2[3];
        f = f[3];
      } while (0 == a);
    }
...
Va$1.prototype.add = function(a, b2, c, d, e2) {
  var f = a.toString();
  a = this.g[f];
  a || (a = this.g[f] = [], this.h++);
  var h = Wa(a, b2, d, e2);
  -1 < h ? (b2 = a[h], c || (b2.ia = false)) : (b2 = new Pa$1(b2, this.src, f, !!d, e2), b2.ia = c, a.push(b2));
  return b2;
};
function Xa(a, b2) {
  var c = b2.type;
  if (c in a.g) {
    var d = a.g[c], e2 = ma(d, b2), f;
    (f = 0 <= e2) && Array.prototype.splice.call(d, e2, 1);
...
function ab(a, b2, c, d, e2) {
  if (d && d.once)
    return bb(a, b2, c, d, e2);
  if (Array.isArray(b2)) {
  ...
  c = cb(c);
  return a && a[A] ? a.O(b2, c, p(d) ? !!d.capture : !!d, e2) : db$1(a, b2, c, false, d, e2);
}
function db$1(a, b2, c, d, e2, f) {
  if (!b2)
    throw Error("Invalid event type");
  var h = p(e2) ? !!e2.capture : !!e2, m = eb(a);
  m || (a[Ya] = m = new Va$1(a));
  c = m.add(b2, c, d, h, f);
  if (c.proxy)
    return c;
  ...
  if (a.addEventListener)
    pa$1 || (e2 = h), void 0 === e2 && (e2 = false), a.addEventListener(b2.toString(), d, e2);
...
function bb(a, b2, c, d, e2) {
  ...
  c = cb(c);
  return a && a[A] ? a.P(b2, c, p(d) ? !!d.capture : !!d, e2) : db$1(a, b2, c, true, d, e2);
}
function ib(a, b2, c, d, e2) {
  if (Array.isArray(b2))
    for (var f = 0; f < b2.length; f++)
      ib(a, b2[f], c, d, e2);
  else
    (d = p(d) ? !!d.capture : !!d, c = cb(c), a && a[A]) ? (a = a.i, b2 = String(b2).toString(), b2 in a.g && (f = a.g[b2], c = Wa(f, c, d, e2), -1 < c && (Qa(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b2], a.h--)))) : a && (a = eb(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Wa(b2, c, d, e2)), (c = -1 < a ? b2[a] : null) && jb(c));
}
function jb(a) {
...
function C$1(a, b2) {
  ...
  if (c)
    for (var f = c.length - 1; 0 <= f; f--) {
      var h = b2.g = c[f];
      e2 = lb(h, d, true, b2) && e2;
    }
  h = b2.g = a;
  e2 = lb(h, d, true, b2) && e2;
  e2 = lb(h, d, false, b2) && e2;
  if (c)
    for (f = 0; f < c.length; f++)
      h = b2.g = c[f], e2 = lb(h, d, false, b2) && e2;
}
B.prototype.N = function() {
  ...
  if (this.i) {
    var a = this.i, c;
    for (c in a.g) {
      for (var d = a.g[c], e2 = 0; e2 < d.length; e2++)
        Qa(d[e2]);
      delete a.g[c];
      a.h--;
    }
...
function lb(a, b2, c, d) {
  ...
  for (var e2 = true, f = 0; f < b2.length; ++f) {
    ...
    if (h && !h.fa && h.capture == c) {
      ...
      h.ia && Xa(a.i, h);
      e2 = false !== m.call(t, d) && e2;
    }
  }
  return e2 && !d.defaultPrevented;
}
...
function Gb(a, b2, c, d) {
  ...
  for (var e2 = 0; e2 < c.length; e2++) {
    var f = ab(b2, c[e2], d || a.handleEvent, false, a.h || a);
    if (!f)
      break;
    a.g[f.key] = f;
  }
...
function Jb(a, b2, c, d, e2, f) {
  a.info(function() {
    if (a.g)
      ...
      h = f;
    return "XMLHTTP REQ (" + d + ") [attempt " + e2 + "]: " + b2 + "\n" + c + "\n" + h;
  });
}
function Kb(a, b2, c, d, e2, f, h) {
  a.info(function() {
    return "XMLHTTP RESP (" + d + ") [ attempt " + e2 + "]: " + b2 + "\n" + c + "\n" + f + " " + h;
  });
}
        ...
        if (!(3 > u) && (3 != u || ya || this.g && (this.h.h || this.g.ja() || oc$1(this.g)))) {
          ...
          b:
            if (qc$1(this)) {
              var d = oc$1(this.g);
              a = "";
              var e2 = d.length, f = 4 == H$1(this.g);
              if (!this.h.i) {
              ...
              for (b2 = 0; b2 < e2; b2++)
                this.h.h = true, a += this.h.i.decode(d[b2], { stream: f && b2 == e2 - 1 });
              d.splice(
                0,
                e2
              );
...
function tc$1(a, b2, c) {
  ...
  for (; !a.J && a.C < c.length; )
    if (e2 = vc$1(a, c), e2 == hc$1) {
      ...
      D$1(a.j, a.m, e2, null), sc$1(a, e2);
  qc$1(a) && e2 != hc$1 && e2 != gc$1 && (a.h.g = "", a.C = 0);
      ...
      if (!a.K && yc$1(c.h, a) && 3 == c.H) {
        ...
        if (Array.isArray(d) && 3 == d.length) {
          ...
          if (0 == e2[0])
            ...
            c.Fa = e2[1], 0 < c.Fa - c.V && 37500 > e2[2] && c.M && 0 == c.A && !c.v && (c.v = Tb(q$1(c.ib, c), 6e3));
          if (1 >= Cc$1(c.h) && c.na) {
            try {
              c.na();
            } catch (n) {
        ...
        for (e2 = c.Ja.g.parse(b2), b2 = 0; b2 < e2.length; b2++) {
          let n = e2[b2];
          c.V = n[0];
          n = n[1];
          if (2 == c.H)
...
function Lc$1(a, b2) {
  if (a.forEach && "function" == typeof a.forEach)
    ...
    for (var c = Kc$1(a), d = Jc$1(a), e2 = d.length, f = 0; f < e2; f++)
...
function Nc$1(a, b2) {
  if (a) {
    ...
    for (var c = 0; c < a.length; c++) {
      var d = a[c].indexOf("="), e2 = null;
      if (0 <= d) {
        var f = a[c].substring(0, d);
        e2 = a[c].substring(d + 1);
      } else
        f = a[c];
...
k$1.toString = function() {
  ...
  for (var c = 0; c < b2.length; c++) {
    ...
    for (d = 0; d < h.length; d++) {
      var e2 = f;
      "" !== h[d] && (e2 += "=" + encodeURIComponent(String(h[d])));
      a.push(e2);
    }
  }
...
function Yc$1(a, b2) {
  b2 && !a.j && (N$1(a), a.i = null, a.g.forEach(function(c, d) {
    var e2 = d.toLowerCase();
    d != e2 && (ad(this, d), mc$1(this, e2, c));
  }, a));
  a.j = b2;
}
var cd = class {
...
function jd(a, b2, c) {
  const d = c || "";
  try {
    Lc$1(a, function(e2, f) {
      let h = e2;
      p(e2) && (h = mb(e2));
      b2.push(d + f + "=" + encodeURIComponent(h));
    });
  } catch (e2) {
    throw b2.push(d + "type=" + encodeURIComponent("_badmap")), e2;
  }
}
function kd(a, b2) {
  const c = new Ib();
...
function ld(a, b2, c, d, e2) {
  try {
    b2.onload = null, b2.onerror = null, b2.onabort = null, b2.ontimeout = null, e2(d);
  } catch (f) {
  }
}
function md(a) {
...
k$1.ha = function(a, b2, c, d) {
  ...
  e2 = l.FormData && a instanceof l.FormData;
  !(0 <= ma(vd, b2)) || d || e2 || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
  for (const [f, h] of c)
    ...
    if (a.v && 4 == H$1(a))
      ...
      try {
        ...
        if (!(c = b2)) {
          var d;
          if (d = 0 === m) {
            var e2 = String(a.I).match(Mc)[1] || null;
            if (!e2 && l.self && l.self.location) {
              var f = l.self.location.protocol;
              e2 = f.substr(0, f.length - 1);
            }
            d = !ud.test(e2 ? e2.toLowerCase() : "");
          }
          c = d;
        }
        if (c)
  ...
  if (this.m)
    if (this.m = null, 1 == this.H) {
      if (!a) {
        ...
        a = this.W++;
        const e2 = new dc$1(this, this.j, a, void 0);
        let f = this.s;
        this.U && (f ? (f = Sa(f), Ua(f, this.U)) : f = this.U);
        null !== this.o || this.O || (e2.I = f, f = null);
        if (this.P)
          a: {
            var b2 = 0;
        ...
        this.P ? (K$1(c, "$req", b2), K$1(c, "SID", "null"), e2.ba = true, ic$1(e2, c, null)) : ic$1(e2, c, b2);
        this.H = 2;
      }
    } else
...
function Ld(a, b2, c) {
  ...
  a: {
    ...
    for (; ; ) {
      const h = ["count=" + c];
      -1 == f ? 0 < c ? (f = e2[0].h, h.push("ofs=" + f)) : f = 0 : h.push("ofs=" + f);
      let m = true;
      for (let t = 0; t < c; t++) {
        let n = e2[t].h;
        const u = e2[t].g;
        n -= f;
        if (0 > n)
          f = Math.max(0, e2[t].h - 100), m = false;
        else
          try {
            jd(u, h, "req" + n + "_");
          } catch (L2) {
  ...
  if (0 != a.H) {
    if (a.ta = b2.aa, b2.i)
      if (1 == d) {
        ...
        Gc$1(a);
    else if (e2 = b2.o, 3 == e2 || 0 == e2 && 0 < a.ta || !(1 == d && Jd(a, b2) || 2 == d && Bc$1(a)))
      switch (c && 0 < c.length && (b2 = a.h, b2.i = b2.i.concat(c)), e2) {
        case 1:
          J$1(a, 5);
          break;
        case 4:
...
function Td(a, b2, c) {
  ...
  if ("string" === typeof b2)
    for (var e2 = 0; 16 > e2; ++e2)
      d[e2] = b2.charCodeAt(c++) | b2.charCodeAt(c++) << 8 | b2.charCodeAt(c++) << 16 | b2.charCodeAt(c++) << 24;
  else
    for (e2 = 0; 16 > e2; ++e2)
      d[e2] = b2[c++] | b2[c++] << 8 | b2[c++] << 16 | b2[c++] << 24;
  b2 = a.g[0];
  c = a.g[1];
  e2 = a.g[2];
  var f = a.g[3];
  var h = b2 + (f ^ c & (e2 ^ f)) + d[0] + 3614090360 & 4294967295;
  b2 = c + (h << 7 & 4294967295 | h >>> 25);
  h = f + (e2 ^ b2 & (c ^ e2)) + d[1] + 3905402710 & 4294967295;
  f = b2 + (h << 12 & 4294967295 | h >>> 20);
  h = e2 + (c ^ f & (b2 ^ c)) + d[2] + 606105819 & 4294967295;
  e2 = f + (h << 17 & 4294967295 | h >>> 15);
  h = c + (b2 ^ e2 & (f ^ b2)) + d[3] + 3250441966 & 4294967295;
  c = e2 + (h << 22 & 4294967295 | h >>> 10);
  h = b2 + (f ^ c & (e2 ^ f)) + d[4] + 4118548399 & 4294967295;
  b2 = c + (h << 7 & 4294967295 | h >>> 25);
  h = f + (e2 ^ b2 & (c ^ e2)) + d[5] + 1200080426 & 4294967295;
  f = b2 + (h << 12 & 4294967295 | h >>> 20);
  h = e2 + (c ^ f & (b2 ^ c)) + d[6] + 2821735955 & 4294967295;
  e2 = f + (h << 17 & 4294967295 | h >>> 15);
  h = c + (b2 ^ e2 & (f ^ b2)) + d[7] + 4249261313 & 4294967295;
  c = e2 + (h << 22 & 4294967295 | h >>> 10);
  h = b2 + (f ^ c & (e2 ^ f)) + d[8] + 1770035416 & 4294967295;
  b2 = c + (h << 7 & 4294967295 | h >>> 25);
  h = f + (e2 ^ b2 & (c ^ e2)) + d[9] + 2336552879 & 4294967295;
  f = b2 + (h << 12 & 4294967295 | h >>> 20);
  h = e2 + (c ^ f & (b2 ^ c)) + d[10] + 4294925233 & 4294967295;
  e2 = f + (h << 17 & 4294967295 | h >>> 15);
  h = c + (b2 ^ e2 & (f ^ b2)) + d[11] + 2304563134 & 4294967295;
  c = e2 + (h << 22 & 4294967295 | h >>> 10);
  h = b2 + (f ^ c & (e2 ^ f)) + d[12] + 1804603682 & 4294967295;
  b2 = c + (h << 7 & 4294967295 | h >>> 25);
  h = f + (e2 ^ b2 & (c ^ e2)) + d[13] + 4254626195 & 4294967295;
  f = b2 + (h << 12 & 4294967295 | h >>> 20);
  h = e2 + (c ^ f & (b2 ^ c)) + d[14] + 2792965006 & 4294967295;
  e2 = f + (h << 17 & 4294967295 | h >>> 15);
  h = c + (b2 ^ e2 & (f ^ b2)) + d[15] + 1236535329 & 4294967295;
  c = e2 + (h << 22 & 4294967295 | h >>> 10);
  h = b2 + (e2 ^ f & (c ^ e2)) + d[1] + 4129170786 & 4294967295;
  b2 = c + (h << 5 & 4294967295 | h >>> 27);
  h = f + (c ^ e2 & (b2 ^ c)) + d[6] + 3225465664 & 4294967295;
  f = b2 + (h << 9 & 4294967295 | h >>> 23);
  h = e2 + (b2 ^ c & (f ^ b2)) + d[11] + 643717713 & 4294967295;
  e2 = f + (h << 14 & 4294967295 | h >>> 18);
  h = c + (f ^ b2 & (e2 ^ f)) + d[0] + 3921069994 & 4294967295;
  c = e2 + (h << 20 & 4294967295 | h >>> 12);
  h = b2 + (e2 ^ f & (c ^ e2)) + d[5] + 3593408605 & 4294967295;
  b2 = c + (h << 5 & 4294967295 | h >>> 27);
  h = f + (c ^ e2 & (b2 ^ c)) + d[10] + 38016083 & 4294967295;
  f = b2 + (h << 9 & 4294967295 | h >>> 23);
  h = e2 + (b2 ^ c & (f ^ b2)) + d[15] + 3634488961 & 4294967295;
  e2 = f + (h << 14 & 4294967295 | h >>> 18);
  h = c + (f ^ b2 & (e2 ^ f)) + d[4] + 3889429448 & 4294967295;
  c = e2 + (h << 20 & 4294967295 | h >>> 12);
  h = b2 + (e2 ^ f & (c ^ e2)) + d[9] + 568446438 & 4294967295;
  b2 = c + (h << 5 & 4294967295 | h >>> 27);
  h = f + (c ^ e2 & (b2 ^ c)) + d[14] + 3275163606 & 4294967295;
  f = b2 + (h << 9 & 4294967295 | h >>> 23);
  h = e2 + (b2 ^ c & (f ^ b2)) + d[3] + 4107603335 & 4294967295;
  e2 = f + (h << 14 & 4294967295 | h >>> 18);
  h = c + (f ^ b2 & (e2 ^ f)) + d[8] + 1163531501 & 4294967295;
  c = e2 + (h << 20 & 4294967295 | h >>> 12);
  h = b2 + (e2 ^ f & (c ^ e2)) + d[13] + 2850285829 & 4294967295;
  b2 = c + (h << 5 & 4294967295 | h >>> 27);
  h = f + (c ^ e2 & (b2 ^ c)) + d[2] + 4243563512 & 4294967295;
  f = b2 + (h << 9 & 4294967295 | h >>> 23);
  h = e2 + (b2 ^ c & (f ^ b2)) + d[7] + 1735328473 & 4294967295;
  e2 = f + (h << 14 & 4294967295 | h >>> 18);
  h = c + (f ^ b2 & (e2 ^ f)) + d[12] + 2368359562 & 4294967295;
  c = e2 + (h << 20 & 4294967295 | h >>> 12);
  h = b2 + (c ^ e2 ^ f) + d[5] + 4294588738 & 4294967295;
  b2 = c + (h << 4 & 4294967295 | h >>> 28);
  h = f + (b2 ^ c ^ e2) + d[8] + 2272392833 & 4294967295;
  f = b2 + (h << 11 & 4294967295 | h >>> 21);
  h = e2 + (f ^ b2 ^ c) + d[11] + 1839030562 & 4294967295;
  e2 = f + (h << 16 & 4294967295 | h >>> 16);
  h = c + (e2 ^ f ^ b2) + d[14] + 4259657740 & 4294967295;
  c = e2 + (h << 23 & 4294967295 | h >>> 9);
  h = b2 + (c ^ e2 ^ f) + d[1] + 2763975236 & 4294967295;
  b2 = c + (h << 4 & 4294967295 | h >>> 28);
  h = f + (b2 ^ c ^ e2) + d[4] + 1272893353 & 4294967295;
  f = b2 + (h << 11 & 4294967295 | h >>> 21);
  h = e2 + (f ^ b2 ^ c) + d[7] + 4139469664 & 4294967295;
  e2 = f + (h << 16 & 4294967295 | h >>> 16);
  h = c + (e2 ^ f ^ b2) + d[10] + 3200236656 & 4294967295;
  c = e2 + (h << 23 & 4294967295 | h >>> 9);
  h = b2 + (c ^ e2 ^ f) + d[13] + 681279174 & 4294967295;
  b2 = c + (h << 4 & 4294967295 | h >>> 28);
  h = f + (b2 ^ c ^ e2) + d[0] + 3936430074 & 4294967295;
  f = b2 + (h << 11 & 4294967295 | h >>> 21);
  h = e2 + (f ^ b2 ^ c) + d[3] + 3572445317 & 4294967295;
  e2 = f + (h << 16 & 4294967295 | h >>> 16);
  h = c + (e2 ^ f ^ b2) + d[6] + 76029189 & 4294967295;
  c = e2 + (h << 23 & 4294967295 | h >>> 9);
  h = b2 + (c ^ e2 ^ f) + d[9] + 3654602809 & 4294967295;
  b2 = c + (h << 4 & 4294967295 | h >>> 28);
  h = f + (b2 ^ c ^ e2) + d[12] + 3873151461 & 4294967295;
  f = b2 + (h << 11 & 4294967295 | h >>> 21);
  h = e2 + (f ^ b2 ^ c) + d[15] + 530742520 & 4294967295;
  e2 = f + (h << 16 & 4294967295 | h >>> 16);
  h = c + (e2 ^ f ^ b2) + d[2] + 3299628645 & 4294967295;
  c = e2 + (h << 23 & 4294967295 | h >>> 9);
  h = b2 + (e2 ^ (c | ~f)) + d[0] + 4096336452 & 4294967295;
  b2 = c + (h << 6 & 4294967295 | h >>> 26);
  h = f + (c ^ (b2 | ~e2)) + d[7] + 1126891415 & 4294967295;
  f = b2 + (h << 10 & 4294967295 | h >>> 22);
  h = e2 + (b2 ^ (f | ~c)) + d[14] + 2878612391 & 4294967295;
  e2 = f + (h << 15 & 4294967295 | h >>> 17);
  h = c + (f ^ (e2 | ~b2)) + d[5] + 4237533241 & 4294967295;
  c = e2 + (h << 21 & 4294967295 | h >>> 11);
  h = b2 + (e2 ^ (c | ~f)) + d[12] + 1700485571 & 4294967295;
  b2 = c + (h << 6 & 4294967295 | h >>> 26);
  h = f + (c ^ (b2 | ~e2)) + d[3] + 2399980690 & 4294967295;
  f = b2 + (h << 10 & 4294967295 | h >>> 22);
  h = e2 + (b2 ^ (f | ~c)) + d[10] + 4293915773 & 4294967295;
  e2 = f + (h << 15 & 4294967295 | h >>> 17);
  h = c + (f ^ (e2 | ~b2)) + d[1] + 2240044497 & 4294967295;
  c = e2 + (h << 21 & 4294967295 | h >>> 11);
  h = b2 + (e2 ^ (c | ~f)) + d[8] + 1873313359 & 4294967295;
  b2 = c + (h << 6 & 4294967295 | h >>> 26);
  h = f + (c ^ (b2 | ~e2)) + d[15] + 4264355552 & 4294967295;
  f = b2 + (h << 10 & 4294967295 | h >>> 22);
  h = e2 + (b2 ^ (f | ~c)) + d[6] + 2734768916 & 4294967295;
  e2 = f + (h << 15 & 4294967295 | h >>> 17);
  h = c + (f ^ (e2 | ~b2)) + d[13] + 1309151649 & 4294967295;
  c = e2 + (h << 21 & 4294967295 | h >>> 11);
  h = b2 + (e2 ^ (c | ~f)) + d[4] + 4149444226 & 4294967295;
  b2 = c + (h << 6 & 4294967295 | h >>> 26);
  h = f + (c ^ (b2 | ~e2)) + d[11] + 3174756917 & 4294967295;
  f = b2 + (h << 10 & 4294967295 | h >>> 22);
  h = e2 + (b2 ^ (f | ~c)) + d[2] + 718787259 & 4294967295;
  e2 = f + (h << 15 & 4294967295 | h >>> 17);
  h = c + (f ^ (e2 | ~b2)) + d[9] + 3951481745 & 4294967295;
  a.g[0] = a.g[0] + b2 & 4294967295;
  a.g[1] = a.g[1] + (e2 + (h << 21 & 4294967295 | h >>> 11)) & 4294967295;
  a.g[2] = a.g[2] + e2 & 4294967295;
  a.g[3] = a.g[3] + f & 4294967295;
}
S$1.prototype.j = function(a, b2) {
  void 0 === b2 && (b2 = a.length);
  for (var c = b2 - this.blockSize, d = this.m, e2 = this.h, f = 0; f < b2; ) {
    if (0 == e2)
      for (; f <= c; )
        Td(this, a, f), f += this.blockSize;
    if ("string" === typeof a)
      for (; f < b2; ) {
        if (d[e2++] = a.charCodeAt(f++), e2 == this.blockSize) {
          Td(this, d);
          e2 = 0;
          break;
        }
...
function T(a, b2) {
  this.h = b2;
  for (var c = [], d = true, e2 = a.length - 1; 0 <= e2; e2--) {
    var f = a[e2] | 0;
    d && f == b2 || (c[e2] = f, d = false);
  }
  this.g = c;
}
var Ud = {};
...
function Xd(a, b2) {
  ...
  for (var c = U$1(Math.pow(b2, 8)), d = V$1, e2 = 0; e2 < a.length; e2 += 8) {
    var f = Math.min(8, a.length - e2), h = parseInt(a.substring(e2, e2 + f), b2);
...
k$1.add = function(a) {
  for (var b2 = Math.max(this.g.length, a.g.length), c = [], d = 0, e2 = 0; e2 <= b2; e2++) {
    var f = d + (this.D(e2) & 65535) + (a.D(e2) & 65535), h = (f >>> 16) + (this.D(e2) >>> 16) + (a.D(e2) >>> 16);
    d = h >>> 16;
    f &= 65535;
    h &= 65535;
    c[e2] = h << 16 | f;
...
k$1.R = function(a) {
  ...
  for (d = 0; d < this.g.length; d++)
    for (var e2 = 0; e2 < a.g.length; e2++) {
      var f = this.D(d) >>> 16, h = this.D(d) & 65535, m = a.D(e2) >>> 16, t = a.D(e2) & 65535;
      c[2 * d + 2 * e2] += h * t;
      be(c, 2 * d + 2 * e2);
      c[2 * d + 2 * e2 + 1] += f * t;
      be(c, 2 * d + 2 * e2 + 1);
...
function $d(a, b2) {
  ...
  if (30 < a.g.length) {
    ...
    for (var c = Yd, d = b2; 0 >= d.X(a); )
      c = de(c), d = de(d);
    var e2 = Z$1(c, 1), f = Z$1(d, 1);
    d = Z$1(d, 2);
    for (c = Z$1(c, 2); !Y$1(d); ) {
      var h = f.add(d);
      0 >= h.X(a) && (e2 = e2.add(c), f = h);
      d = Z$1(d, 1);
      c = Z$1(c, 1);
    }
    b2 = ae(a, e2.R(b2));
...
function Z$1(a, b2) {
  var c = b2 >> 5;
  b2 %= 32;
  for (var d = a.g.length - c, e2 = [], f = 0; f < d; f++)
    e2[f] = 0 < b2 ? a.D(f + c) >>> b2 | a.D(f + c + 1) << 32 - b2 : a.D(f + c);
  return new T(e2, a.h);
}
...
function O(t = "Unexpected state") {
  const e2 = `FIRESTORE (${S}) INTERNAL ASSERTION FAILED: ` + t;
  throw k(e2), new Error(e2);
}
function F(t, e2) {
  t || O();
}
...
class U extends FirebaseError {
  constructor(t, e2) {
    super(t, e2), this.code = t, this.message = e2, this.toString = () => `${this.name}: [code=${this.code}]: ${this.message}`;
  }
}
/**
 * @license
...
class K {
  constructor() {
    this.promise = new Promise((t, e2) => {
      this.resolve = t, this.reject = e2;
    });
  }
}
/**
...
class G {
  constructor(t, e2) {
    this.user = e2, this.type = "OAuth", this.headers = /* @__PURE__ */ new Map(), this.headers.set("Authorization", `Bearer ${t}`);
  }
}
class Q {
  getToken() {
  ...
  start(t, e2) {
    t.enqueueRetryable(() => e2(V.UNAUTHENTICATED));
  }
  shutdown() {
  }
}
class j {
  ...
  start(t, e2) {
    this.changeListener = e2, t.enqueueRetryable(() => e2(this.token.user));
  }
  shutdown() {
...
class z {
  ...
  start(t, e2) {
    let n = this.i;
    const s = (t2) => this.i !== n ? (n = this.i, e2(t2)) : Promise.resolve();
    let i = new K();
    this.o = () => {
    ...
    const r2 = () => {
      ...
      t.enqueueRetryable(async () => {
        await e3.promise, await s(this.currentUser);
      });
    }, o = (t2) => {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e2).then((e3) => this.i !== t ? (N("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e3 ? (F("string" == typeof e3.accessToken), new G(e3.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
...
class W {
  constructor(t, e2, n) {
    this.h = t, this.l = e2, this.m = n, this.type = "FirstParty", this.user = V.FIRST_PARTY, this.g = /* @__PURE__ */ new Map();
  }
  p() {
...
class H {
  constructor(t, e2, n) {
    this.h = t, this.l = e2, this.m = n;
  }
  getToken() {
    return Promise.resolve(new W(this.h, this.l, this.m));
  }
  start(t, e2) {
    t.enqueueRetryable(() => e2(V.FIRST_PARTY));
  }
  shutdown() {
  }
  invalidateToken() {
...
class Y {
  ...
  start(t, e2) {
    const n = (t2) => {
      ...
      return this.T = t2.token, N("FirebaseAppCheckTokenProvider", `Received ${n2 ? "new" : "existing"} token.`), n2 ? e2(t2.token) : Promise.resolve();
    };
    this.o = (e3) => {
      t.enqueueRetryable(() => n(e3));
    };
    const s = (t2) => {
 ...
 */
function Z(t) {
  const e2 = "undefined" != typeof self && (self.crypto || self.msCrypto), n = new Uint8Array(t);
  if (e2 && "function" == typeof e2.getRandomValues)
    e2.getRandomValues(n);
  else
    for (let e3 = 0; e3 < t; e3++)
      n[e3] = Math.floor(256 * Math.random());
  return n;
}
/**
 * @license
...
class tt {
  static A() {
    const t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", e2 = Math.floor(256 / t.length) * t.length;
    let n = "";
    for (; n.length < 20; ) {
      const s = Z(40);
      for (let i = 0; i < s.length; ++i)
        n.length < 20 && s[i] < e2 && (n += t.charAt(s[i] % t.length));
    }
    return n;
  }
}
function et(t, e2) {
  return t < e2 ? -1 : t > e2 ? 1 : 0;
}
function nt(t, e2, n) {
  return t.length === e2.length && t.every((t2, s) => n(t2, e2[s]));
}
/**
 * @license
 * Copyright 2017 Google LLC
...
class it {
  constructor(t, e2) {
    if (this.seconds = t, this.nanoseconds = e2, e2 < 0)
      throw new U(q.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e2);
    if (e2 >= 1e9)
      throw new U(q.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e2);
    if (t < -62135596800)
  ...
  static fromMillis(t) {
    const e2 = Math.floor(t / 1e3), n = Math.floor(1e6 * (t - 1e3 * e2));
    return new it(e2, n);
  }
  toDate() {
...
class ot {
  constructor(t, e2, n) {
    void 0 === e2 ? e2 = 0 : e2 > t.length && O(), void 0 === n ? n = t.length - e2 : n > t.length - e2 && O(), this.segments = t, this.offset = e2, this.len = n;
  }
  get length() {
    return this.len;
  }
  ...
  forEach(t) {
    for (let e2 = this.offset, n = this.limit(); e2 < n; e2++)
      t(this.segments[e2]);
  }
  toArray() {
    return this.segments.slice(this.offset, this.limit());
  }
  static comparator(t, e2) {
    const n = Math.min(t.length, e2.length);
    for (let s = 0; s < n; s++) {
      const n2 = t.get(s), i = e2.get(s);
      if (n2 < i)
        return -1;
      if (n2 > i)
        return 1;
    }
    return t.length < e2.length ? -1 : t.length > e2.length ? 1 : 0;
  }
}
class ut extends ot {
  construct(t, e2, n) {
    return new ut(t, e2, n);
  }
  canonicalString() {
  ...
  static fromString(...t) {
    ...
    for (const n of t) {
      ...
      e2.push(...n.split("/").filter((t2) => t2.length > 0));
    }
    return new ut(e2);
  }
  static emptyPath() {
...
class ht {
  ...
  static comparator(t, e2) {
    return ut.comparator(t.path, e2.path);
  }
...
class It {
  constructor(t, e2, n) {
    this.readTime = t, this.documentKey = e2, this.largestBatchId = n;
  }
  static min() {
...
function Tt(t, e2) {
  let n = t.readTime.compareTo(e2.readTime);
  return 0 !== n ? n : (n = ht.comparator(t.documentKey, e2.documentKey), 0 !== n ? n : et(t.largestBatchId, e2.largestBatchId));
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class Rt {
  ...
  next(t, e2) {
    return this.callbackAttached && O(), this.callbackAttached = true, this.isDone ? this.error ? this.wrapFailure(e2, this.error) : this.wrapSuccess(t, this.result) : new Rt((n, s) => {
      this.nextCallback = (e3) => {
        this.wrapSuccess(t, e3).next(n, s);
      }, this.catchCallback = (t2) => {
        this.wrapFailure(e2, t2).next(n, s);
      };
    });
  }
  toPromise() {
  ...
  wrapUserFunction(t) {
    try {
      const e2 = t();
      return e2 instanceof Rt ? e2 : Rt.resolve(e2);
    } catch (t2) {
      return Rt.reject(t2);
    }
  }
  wrapSuccess(t, e2) {
    return t ? this.wrapUserFunction(() => t(e2)) : Rt.resolve(e2);
  }
  wrapFailure(t, e2) {
    return t ? this.wrapUserFunction(() => t(e2)) : Rt.reject(e2);
  }
  static resolve(t) {
    return new Rt((e2, n) => {
      e2(t);
  ...
  static or(t) {
    let e2 = Rt.resolve(false);
    for (const n of t)
      e2 = e2.next((t2) => t2 ? Rt.resolve(t2) : n());
    return e2;
  }
  static forEach(t, e2) {
    const n = [];
    return t.forEach((t2, s) => {
      n.push(e2.call(this, t2, s));
    }), this.waitFor(n);
  }
  static mapArray(t, e2) {
    return new Rt((n, s) => {
...
class Ot {
  constructor(t, e2) {
    this.previousValue = t, e2 && (e2.sequenceNumberHandler = (t2) => this.ot(t2), this.ut = (t2) => e2.writeSequenceNumber(t2));
  }
  ot(t) {
...
function me(t) {
  let e2 = 0;
  for (const n in t)
    Object.prototype.hasOwnProperty.call(t, n) && e2++;
  return e2;
}
function ge(t, e2) {
  for (const n in t)
...
class pe {
  constructor(t, e2) {
    this.comparator = t, this.root = e2 || Te.EMPTY;
  }
  insert(t, e2) {
    return new pe(this.comparator, this.root.insert(t, e2, this.comparator).copy(null, null, Te.BLACK, null, null));
  }
  remove(t) {
  ...
  get(t) {
    let e2 = this.root;
    for (; !e2.isEmpty(); ) {
      const n = this.comparator(t, e2.key);
      if (0 === n)
        return e2.value;
      n < 0 ? e2 = e2.left : n > 0 && (e2 = e2.right);
    }
    return null;
  }
  indexOf(t) {
    let e2 = 0, n = this.root;
    for (; !n.isEmpty(); ) {
      const s = this.comparator(t, n.key);
      if (0 === s)
        return e2 + n.left.size;
      s < 0 ? n = n.left : (e2 += n.left.size + 1, n = n.right);
    }
    return -1;
  }
  isEmpty() {
  ...
  forEach(t) {
    this.inorderTraversal((e2, n) => (t(e2, n), false));
  }
  toString() {
    const t = [];
    return this.inorderTraversal((e2, n) => (t.push(`${e2}:${n}`), false)), `{${t.join(", ")}}`;
  }
  reverseTraversal(t) {
...
class Ie {
  constructor(t, e2, n, s) {
    this.isReverse = s, this.nodeStack = [];
    let i = 1;
    for (; !t.isEmpty(); )
      if (i = e2 ? n(t.key, e2) : 1, e2 && s && (i *= -1), i < 0)
...
class Te {
  constructor(t, e2, n, s, i) {
    this.key = t, this.value = e2, this.color = null != n ? n : Te.RED, this.left = null != s ? s : Te.EMPTY, this.right = null != i ? i : Te.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  copy(t, e2, n, s, i) {
    return new Te(null != t ? t : this.key, null != e2 ? e2 : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
  }
  isEmpty() {
    return false;
  }
  ...
  insert(t, e2, n) {
    let s = this;
    const i = n(t, s.key);
    return s = i < 0 ? s.copy(null, null, null, s.left.insert(t, e2, n), null) : 0 === i ? s.copy(null, e2, null, null, null) : s.copy(null, null, null, null, s.right.insert(t, e2, n)), s.fixUp();
  }
  removeMin() {
  ...
  remove(t, e2) {
    let n, s = this;
    if (e2(t, s.key) < 0)
      s.left.isEmpty() || s.left.isRed() || s.left.left.isRed() || (s = s.moveRedLeft()), s = s.copy(null, null, null, s.left.remove(t, e2), null);
    else {
      if (s.left.isRed() && (s = s.rotateRight()), s.right.isEmpty() || s.right.isRed() || s.right.left.isRed() || (s = s.moveRedRight()), 0 === e2(t, s.key)) {
        if (s.right.isEmpty())
          return Te.EMPTY;
        n = s.right.min(), s = s.copy(n.key, n.value, null, null, s.right.removeMin());
      }
      s = s.copy(null, null, null, null, s.right.remove(t, e2));
    }
    return s.fixUp();
  }
  isRed() {
  ...
  colorFlip() {
    const t = this.left.copy(null, null, !this.left.color, null, null), e2 = this.right.copy(null, null, !this.right.color, null, null);
    return this.copy(null, null, !this.color, t, e2);
  }
  checkMaxDepth() {
    const t = this.check();
...
class Ee {
  ...
  forEach(t) {
    this.data.inorderTraversal((e2, n) => (t(e2), false));
  }
  forEachInRange(t, e2) {
  ...
  forEachWhile(t, e2) {
    let n;
    for (n = void 0 !== e2 ? this.data.getIteratorFrom(e2) : this.data.getIterator(); n.hasNext(); ) {
      if (!t(n.getNext().key))
        return;
    }
  }
  firstAfterOrEqual(t) {
    const e2 = this.data.getIteratorFrom(t);
  ...
  unionWith(t) {
    let e2 = this;
    return e2.size < t.size && (e2 = t, t = this), t.forEach((t2) => {
      e2 = e2.add(t2);
    }), e2;
  }
  isEqual(t) {
    ...
    if (this.size !== t.size)
      return false;
    const e2 = this.data.getIterator(), n = t.data.getIterator();
    for (; e2.hasNext(); ) {
      const t2 = e2.getNext().key, s = n.getNext().key;
  ...
  toString() {
    const t = [];
    return this.forEach((e2) => t.push(e2)), "SortedSet(" + t.toString() + ")";
  }
  copy(t) {
    const e2 = new Ee(this.comparator);
    return e2.data = t, e2;
  }
}
class Ae {
...
class Re {
  ...
  unionWith(t) {
    let e2 = new Ee(at.comparator);
    for (const t2 of this.fields)
      e2 = e2.add(t2);
    for (const n of t)
      e2 = e2.add(n);
    return new Re(e2.toArray());
  }
  covers(t) {
  ...
  isEqual(t) {
    return nt(this.fields, t.fields, (t2, e2) => t2.isEqual(e2));
  }
}
/**
 * @license
...
class Ve {
  ...
  toUint8Array() {
    return function(t) {
      const e2 = new Uint8Array(t.length);
...
function De(t) {
  if (F(!!t), "string" == typeof t) {
    ...
    if (F(!!n), n[1]) {
      let t2 = n[1];
      t2 = (t2 + "000000000").substr(0, 9), e2 = Number(t2);
    }
    const s = new Date(t);
    return {
...
function Ne(t) {
  var e2, n;
  return "server_timestamp" === (null === (n = ((null === (e2 = null == t ? void 0 : t.mapValue) || void 0 === e2 ? void 0 : e2.fields) || {}).__type__) || void 0 === n ? void 0 : n.stringValue);
}
function ke(t) {
  const e2 = t.mapValue.fields.__previous_value__;
  return Ne(e2) ? ke(e2) : e2;
}
function Me(t) {
  const e2 = De(t.mapValue.fields.__local_write_time__.timestampValue);
  return new it(e2.seconds, e2.nanos);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */
class $e {
  constructor(t, e2, n, s, i, r2, o, u, c) {
    this.databaseId = t, this.appId = e2, this.persistenceKey = n, this.host = s, this.ssl = i, this.forceLongPolling = r2, this.autoDetectLongPolling = o, this.longPollingOptions = u, this.useFetchStreams = c;
  }
}
class Oe {
  constructor(t, e2) {
    this.projectId = t, this.database = e2 || "(default)";
  }
  static empty() {
    return new Oe("", "");
  }
...
function qe(t, e2) {
  ...
  switch (n) {
    ...
    case 9007199254740991:
      return true;
    case 1:
      return t.booleanValue === e2.booleanValue;
    case 4:
      return Me(t).isEqual(Me(e2));
    case 3:
      return function(t2, e3) {
        if ("string" == typeof t2.timestampValue && "string" == typeof e3.timestampValue && t2.timestampValue.length === e3.timestampValue.length)
          return t2.timestampValue === e3.timestampValue;
        const n2 = De(t2.timestampValue), s = De(e3.timestampValue);
        return n2.seconds === s.seconds && n2.nanos === s.nanos;
      }(t, e2);
    case 5:
      return t.stringValue === e2.stringValue;
    case 6:
      return function(t2, e3) {
        return xe(t2.bytesValue).isEqual(xe(e3.bytesValue));
      }(t, e2);
    case 7:
      return t.referenceValue === e2.referenceValue;
    case 8:
      return function(t2, e3) {
        return Ce(t2.geoPointValue.latitude) === Ce(e3.geoPointValue.latitude) && Ce(t2.geoPointValue.longitude) === Ce(e3.geoPointValue.longitude);
      }(t, e2);
    case 2:
      return function(t2, e3) {
        if ("integerValue" in t2 && "integerValue" in e3)
          return Ce(t2.integerValue) === Ce(e3.integerValue);
        if ("doubleValue" in t2 && "doubleValue" in e3) {
          const n2 = Ce(t2.doubleValue), s = Ce(e3.doubleValue);
          return n2 === s ? Bt(n2) === Bt(s) : isNaN(n2) && isNaN(s);
        }
        return false;
      }(t, e2);
    case 9:
      return nt(t.arrayValue.values || [], e2.arrayValue.values || [], qe);
    case 10:
      return function(t2, e3) {
        const n2 = t2.mapValue.fields || {}, s = e3.mapValue.fields || {};
        if (me(n2) !== me(s))
          return false;
        for (const t3 in n2)
...
function Ue(t, e2) {
  return void 0 !== (t.values || []).find((t2) => qe(t2, e2));
}
function Ke(t, e2) {
  if (t === e2)
    return 0;
  const n = Le(t), s = Le(e2);
  if (n !== s)
    return et(n, s);
  switch (n) {
    case 0:
    case 9007199254740991:
      return 0;
    case 1:
      return et(t.booleanValue, e2.booleanValue);
    case 2:
      return function(t2, e3) {
        const n2 = Ce(t2.integerValue || t2.doubleValue), s2 = Ce(e3.integerValue || e3.doubleValue);
        return n2 < s2 ? -1 : n2 > s2 ? 1 : n2 === s2 ? 0 : isNaN(n2) ? isNaN(s2) ? 0 : -1 : 1;
      }(t, e2);
    case 3:
      return Ge(t.timestampValue, e2.timestampValue);
    case 4:
      return Ge(Me(t), Me(e2));
    case 5:
      return et(t.stringValue, e2.stringValue);
    case 6:
      return function(t2, e3) {
        const n2 = xe(t2), s2 = xe(e3);
        return n2.compareTo(s2);
      }(t.bytesValue, e2.bytesValue);
    case 7:
      return function(t2, e3) {
        const n2 = t2.split("/"), s2 = e3.split("/");
        for (let t3 = 0; t3 < n2.length && t3 < s2.length; t3++) {
          const e4 = et(n2[t3], s2[t3]);
          if (0 !== e4)
            return e4;
        }
        return et(n2.length, s2.length);
      }(t.referenceValue, e2.referenceValue);
    case 8:
      return function(t2, e3) {
        const n2 = et(Ce(t2.latitude), Ce(e3.latitude));
        if (0 !== n2)
          return n2;
        return et(Ce(t2.longitude), Ce(e3.longitude));
      }(t.geoPointValue, e2.geoPointValue);
    case 9:
      return function(t2, e3) {
        const n2 = t2.values || [], s2 = e3.values || [];
        for (let t3 = 0; t3 < n2.length && t3 < s2.length; ++t3) {
          const e4 = Ke(n2[t3], s2[t3]);
          if (e4)
            return e4;
        }
        return et(n2.length, s2.length);
      }(t.arrayValue, e2.arrayValue);
    case 10:
      return function(t2, e3) {
        if (t2 === Fe.mapValue && e3 === Fe.mapValue)
          return 0;
        if (t2 === Fe.mapValue)
          return 1;
        if (e3 === Fe.mapValue)
          return -1;
        const n2 = t2.fields || {}, s2 = Object.keys(n2), i = e3.fields || {}, r2 = Object.keys(i);
        s2.sort(), r2.sort();
        for (let t3 = 0; t3 < s2.length && t3 < r2.length; ++t3) {
          const e4 = et(s2[t3], r2[t3]);
          if (0 !== e4)
            return e4;
      ...
      }(t.mapValue, e2.mapValue);
    default:
      throw O();
  }
}
function Ge(t, e2) {
  if ("string" == typeof t && "string" == typeof e2 && t.length === e2.length)
    return et(t, e2);
  const n = De(t), s = De(e2), i = et(n.seconds, s.seconds);
...
function je(t) {
  ...
  }(t.timestampValue) : "stringValue" in t ? t.stringValue : "bytesValue" in t ? xe(t.bytesValue).toBase64() : "referenceValue" in t ? (n = t.referenceValue, ht.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e2 = t.geoPointValue).latitude},${e2.longitude})` : "arrayValue" in t ? function(t2) {
    let e3 = "[", n2 = true;
    for (const s of t2.values || [])
      n2 ? n2 = false : e3 += ",", e3 += je(s);
    return e3 + "]";
  }(t.arrayValue) : "mapValue" in t ? function(t2) {
    const e3 = Object.keys(t2.fields || {}).sort();
    let n2 = "{", s = true;
    for (const i of e3)
...
function tn(t) {
  ...
  if (t.mapValue) {
    ...
    return ge(t.mapValue.fields, (t2, n) => e2.mapValue.fields[t2] = tn(n)), e2;
  }
  if (t.arrayValue) {
    const e2 = {
      arrayValue: {
    ...
    for (let n = 0; n < (t.arrayValue.values || []).length; ++n)
      e2.arrayValue.values[n] = tn(t.arrayValue.values[n]);
    return e2;
  }
...
class un {
  ...
  field(t) {
      ...
      return this.value;
    {
      ...
      for (let n = 0; n < t.length - 1; ++n)
        if (e2 = (e2.mapValue.fields || {})[t.get(n)], !Ze(e2))
          return null;
      return e2 = (e2.mapValue.fields || {})[t.lastSegment()], e2 || null;
    }
  }
  set(t, e2) {
    this.getFieldsMap(t.popLast())[t.lastSegment()] = tn(e2);
  }
  setAll(t) {
    let e2 = at.emptyPath(), n = {}, s = [];
    t.forEach((t2, i2) => {
      if (!e2.isImmediateParentOf(i2)) {
        const t3 = this.getFieldsMap(e2);
        this.applyChanges(t3, n, s), n = {}, s = [], e2 = i2.popLast();
      }
      t2 ? n[i2.lastSegment()] = tn(t2) : s.push(i2.lastSegment());
    });
    const i = this.getFieldsMap(e2);
    this.applyChanges(i, n, s);
  }
  delete(t) {
    const e2 = this.field(t.popLast());
    Ze(e2) && e2.mapValue.fields && delete e2.mapValue.fields[t.lastSegment()];
  }
  isEqual(t) {
  ...
  getFieldsMap(t) {
    ...
    for (let n = 0; n < t.length; ++n) {
      let s = e2.mapValue.fields[t.get(n)];
      Ze(s) && s.mapValue.fields || (s = {
        mapValue: {
          fields: {}
        }
      }, e2.mapValue.fields[t.get(n)] = s), e2 = s;
    }
 ...
 */
class an {
  constructor(t, e2, n, s, i, r2, o) {
    this.key = t, this.documentType = e2, this.version = n, this.readTime = s, this.createTime = i, this.data = r2, this.documentState = o;
  }
  ...
  static newFoundDocument(t, e2, n, s) {
    return new an(
      t,
      1,
      e2,
  ...
  static newUnknownDocument(t, e2) {
    return new an(
      t,
      3,
      e2,
  ...
  convertToFoundDocument(t, e2) {
    return !this.createTime.isEqual(rt.min()) || 2 !== this.documentType && 0 !== this.documentType || (this.createTime = t), this.version = t, this.documentType = 1, this.data = e2, this.documentState = 0, this;
  }
...
class hn {
  constructor(t, e2) {
    this.position = t, this.inclusive = e2;
  }
}
function ln(t, e2, n) {
  let s = 0;
  for (let i = 0; i < t.position.length; i++) {
    const r2 = e2[i], o = t.position[i];
...
function fn(t, e2) {
  ...
  if (null === e2)
    return false;
  if (t.inclusive !== e2.inclusive || t.position.length !== e2.position.length)
    return false;
  for (let n = 0; n < t.position.length; n++) {
    if (!qe(t.position[n], e2.position[n]))
      return false;
  }
  return true;
}
 ...
 */
class dn {
  constructor(t, e2 = "asc") {
    this.field = t, this.dir = e2;
  }
}
function wn(t, e2) {
  return t.dir === e2.dir && t.field.isEqual(e2.field);
}
/**
 * @license
 * Copyright 2022 Google LLC
...
class mn extends _n {
  constructor(t, e2, n) {
    super(), this.field = t, this.op = e2, this.value = n;
  }
  static create(t, e2, n) {
    return t.isKeyField() ? "in" === e2 || "not-in" === e2 ? this.createKeyFieldInFilter(t, e2, n) : new Pn(t, e2, n) : "array-contains" === e2 ? new Dn(t, n) : "in" === e2 ? new Cn(t, n) : "not-in" === e2 ? new xn(t, n) : "array-contains-any" === e2 ? new Nn(t, n) : new mn(t, e2, n);
  }
  static createKeyFieldInFilter(t, e2, n) {
    return "in" === e2 ? new bn(t, n) : new Vn(t, n);
  }
  matches(t) {
    const e2 = t.data.field(this.field);
    return "!=" === this.op ? null !== e2 && this.matchesComparison(Ke(e2, this.value)) : null !== e2 && Le(this.value) === Le(e2) && this.matchesComparison(Ke(e2, this.value));
  }
  matchesComparison(t) {
    switch (this.op) {
      case "<":
...
class gn extends _n {
  constructor(t, e2) {
    super(), this.filters = t, this.op = e2, this.lt = null;
  }
  static create(t, e2) {
    return new gn(t, e2);
  }
  matches(t) {
    return yn(this) ? void 0 === this.filters.find((e2) => !e2.matches(t)) : void 0 !== this.filters.find((e2) => e2.matches(t));
  }
  getFlattenedFilters() {
    return null !== this.lt || (this.lt = this.filters.reduce((t, e2) => t.concat(e2.getFlattenedFilters()), [])), this.lt;
  }
  getFilters() {
...
function En(t) {
  ...
  {
    const e2 = t.filters.map((t2) => En(t2)).join(",");
    return `${t.op}(${e2})`;
  }
}
function An(t, e2) {
  return t instanceof mn ? function(t2, e3) {
    return e3 instanceof mn && t2.op === e3.op && t2.field.isEqual(e3.field) && qe(t2.value, e3.value);
  }(t, e2) : t instanceof gn ? function(t2, e3) {
    if (e3 instanceof gn && t2.op === e3.op && t2.filters.length === e3.filters.length) {
      return t2.filters.reduce((t3, n, s) => t3 && An(n, e3.filters[s]), true);
    }
    return false;
  }(t, e2) : void O();
}
...
class Pn extends mn {
  constructor(t, e2, n) {
    super(t, e2, n), this.key = ht.fromName(n.referenceValue);
  }
  matches(t) {
    const e2 = ht.comparator(t.key, this.key);
    return this.matchesComparison(e2);
  }
}
class bn extends mn {
  constructor(t, e2) {
    super(t, "in", e2), this.keys = Sn("in", e2);
  }
  matches(t) {
    return this.keys.some((e2) => e2.isEqual(t.key));
  }
}
class Vn extends mn {
  constructor(t, e2) {
    super(t, "not-in", e2), this.keys = Sn("not-in", e2);
  }
  matches(t) {
    return !this.keys.some((e2) => e2.isEqual(t.key));
  }
...
function Sn(t, e2) {
  var n;
  return ((null === (n = e2.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t2) => ht.fromName(t2.referenceValue));
}
class Dn extends mn {
  constructor(t, e2) {
    super(t, "array-contains", e2);
  }
  matches(t) {
    const e2 = t.data.field(this.field);
    return Je(e2) && Ue(e2.arrayValue, this.value);
  }
}
class Cn extends mn {
  constructor(t, e2) {
  ...
  matches(t) {
    const e2 = t.data.field(this.field);
    return null !== e2 && Ue(this.value.arrayValue, e2);
  }
}
class xn extends mn {
  constructor(t, e2) {
...
class Nn extends mn {
  constructor(t, e2) {
    super(t, "array-contains-any", e2);
  }
  matches(t) {
    const e2 = t.data.field(this.field);
    return !(!Je(e2) || !e2.arrayValue.values) && e2.arrayValue.values.some((t2) => Ue(this.value.arrayValue, t2));
  }
}
/**
 * @license
 ...
 */
class kn {
  constructor(t, e2 = null, n = [], s = [], i = null, r2 = null, o = null) {
    this.path = t, this.collectionGroup = e2, this.orderBy = n, this.filters = s, this.limit = i, this.startAt = r2, this.endAt = o, this.dt = null;
  }
}
function Mn(t, e2 = null, n = [], s = [], i = null, r2 = null, o = null) {
  return new kn(t, e2, n, s, i, r2, o);
}
function $n(t) {
  const e2 = L(t);
  if (null === e2.dt) {
    let t2 = e2.path.canonicalString();
    null !== e2.collectionGroup && (t2 += "|cg:" + e2.collectionGroup), t2 += "|f:", t2 += e2.filters.map((t3) => En(t3)).join(","), t2 += "|ob:", t2 += e2.orderBy.map((t3) => function(t4) {
      return t4.field.canonicalString() + t4.dir;
    }(t3)).join(","), Ft(e2.limit) || (t2 += "|l:", t2 += e2.limit), e2.startAt && (t2 += "|lb:", t2 += e2.startAt.inclusive ? "b:" : "a:", t2 += e2.startAt.position.map((t3) => Qe(t3)).join(",")), e2.endAt && (t2 += "|ub:", t2 += e2.endAt.inclusive ? "a:" : "b:", t2 += e2.endAt.position.map((t3) => Qe(t3)).join(",")), e2.dt = t2;
  }
  return e2.dt;
}
function On(t, e2) {
  if (t.limit !== e2.limit)
    return false;
  if (t.orderBy.length !== e2.orderBy.length)
    return false;
  for (let n = 0; n < t.orderBy.length; n++)
    if (!wn(t.orderBy[n], e2.orderBy[n]))
      return false;
  if (t.filters.length !== e2.filters.length)
    return false;
  for (let n = 0; n < t.filters.length; n++)
    if (!An(t.filters[n], e2.filters[n]))
      return false;
  return t.collectionGroup === e2.collectionGroup && (!!t.path.isEqual(e2.path) && (!!fn(t.startAt, e2.startAt) && fn(t.endAt, e2.endAt)));
}
function Fn(t) {
 ...
 */
class Un {
  constructor(t, e2 = null, n = [], s = [], i = null, r2 = "F", o = null, u = null) {
    this.path = t, this.collectionGroup = e2, this.explicitOrderBy = n, this.filters = s, this.limit = i, this.limitType = r2, this.startAt = o, this.endAt = u, this.wt = null, this._t = null, this.startAt, this.endAt;
  }
}
function Kn(t, e2, n, s, i, r2, o, u) {
  return new Un(t, e2, n, s, i, r2, o, u);
}
function Gn(t) {
  return new Un(t);
}
...
function zn(t) {
  for (const e2 of t.filters) {
    const t2 = e2.getFirstInequalityField();
    if (null !== t2)
      return t2;
  }
  return null;
...
function Hn(t) {
  ...
  if (null === e2.wt) {
    e2.wt = [];
    const t2 = zn(e2), n = jn(e2);
    if (null !== t2 && null === n)
      t2.isKeyField() || e2.wt.push(new dn(t2)), e2.wt.push(new dn(at.keyField(), "asc"));
    else {
      let t3 = false;
      for (const n2 of e2.explicitOrderBy)
        e2.wt.push(n2), n2.field.isKeyField() && (t3 = true);
      if (!t3) {
        const t4 = e2.explicitOrderBy.length > 0 ? e2.explicitOrderBy[e2.explicitOrderBy.length - 1].dir : "asc";
        e2.wt.push(new dn(at.keyField(), t4));
      }
    }
  }
  return e2.wt;
...
function Jn(t) {
  ...
  if (!e2._t)
    if ("F" === e2.limitType)
      e2._t = Mn(e2.path, e2.collectionGroup, Hn(e2), e2.filters, e2.limit, e2.startAt, e2.endAt);
    else {
      const t2 = [];
      for (const n2 of Hn(e2)) {
        const e3 = "desc" === n2.dir ? "asc" : "desc";
        t2.push(new dn(n2.field, e3));
      }
      const n = e2.endAt ? new hn(e2.endAt.position, e2.endAt.inclusive) : null, s = e2.startAt ? new hn(e2.startAt.position, e2.startAt.inclusive) : null;
      e2._t = Mn(e2.path, e2.collectionGroup, t2, e2.filters, e2.limit, n, s);
    }
  return e2._t;
}
function Xn(t, e2, n) {
  return new Un(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), e2, n, t.startAt, t.endAt);
}
function Zn(t, e2) {
  return On(Jn(t), Jn(e2)) && t.limitType === e2.limitType;
}
function ts(t) {
...
function es(t) {
  return `Query(target=${function(t2) {
    ...
    return null !== t2.collectionGroup && (e2 += " collectionGroup=" + t2.collectionGroup), t2.filters.length > 0 && (e2 += `, filters: [${t2.filters.map((t3) => Rn(t3)).join(", ")}]`), Ft(t2.limit) || (e2 += ", limit: " + t2.limit), t2.orderBy.length > 0 && (e2 += `, orderBy: [${t2.orderBy.map((t3) => function(t4) {
      return `${t4.field.canonicalString()} (${t4.dir})`;
    }(t3)).join(", ")}]`), t2.startAt && (e2 += ", startAt: ", e2 += t2.startAt.inclusive ? "b:" : "a:", e2 += t2.startAt.position.map((t3) => Qe(t3)).join(",")), t2.endAt && (e2 += ", endAt: ", e2 += t2.endAt.inclusive ? "a:" : "b:", e2 += t2.endAt.position.map((t3) => Qe(t3)).join(",")), `Target(${e2})`;
  }(Jn(t))}; limitType=${t.limitType})`;
}
function ns(t, e2) {
  return e2.isFoundDocument() && function(t2, e3) {
    const n = e3.key.path;
    return null !== t2.collectionGroup ? e3.key.hasCollectionId(t2.collectionGroup) && t2.path.isPrefixOf(n) : ht.isDocumentKey(t2.path) ? t2.path.isEqual(n) : t2.path.isImmediateParentOf(n);
  }(t, e2) && function(t2, e3) {
    for (const n of Hn(t2))
      if (!n.field.isKeyField() && null === e3.data.field(n.field))
        return false;
    return true;
  }(t, e2) && function(t2, e3) {
    ...
    if (t2.startAt && !function(t3, e4, n) {
      const s = ln(t3, e4, n);
      return t3.inclusive ? s <= 0 : s < 0;
    }(t2.startAt, Hn(t2), e3))
      return false;
    if (t2.endAt && !function(t3, e4, n) {
      const s = ln(t3, e4, n);
      return t3.inclusive ? s >= 0 : s > 0;
    }(t2.endAt, Hn(t2), e3))
      return false;
...
function rs(t, e2, n) {
  const s = t.field.isKeyField() ? ht.comparator(e2.key, n.key) : function(t2, e3, n2) {
    const s2 = e3.data.field(t2), i = n2.data.field(t2);
...
class os {
  constructor(t, e2) {
    this.mapKeyFn = t, this.equalsFn = e2, this.inner = {}, this.innerSize = 0;
  }
  get(t) {
    const e2 = this.mapKeyFn(t), n = this.inner[e2];
    if (void 0 !== n) {
      for (const [e3, s] of n)
        if (this.equalsFn(e3, t))
          return s;
    }
  }
  has(t) {
  ...
  set(t, e2) {
    ...
    if (void 0 === s)
      return this.inner[n] = [[t, e2]], void this.innerSize++;
    for (let n2 = 0; n2 < s.length; n2++)
      if (this.equalsFn(s[n2][0], t))
        return void (s[n2] = [t, e2]);
    s.push([t, e2]), this.innerSize++;
  }
  delete(t) {
    const e2 = this.mapKeyFn(t), n = this.inner[e2];
    if (void 0 === n)
    ...
    for (let s = 0; s < n.length; s++)
      if (this.equalsFn(n[s][0], t))
        return 1 === n.length ? delete this.inner[e2] : n.splice(s, 1), this.innerSize--, true;
    return false;
  }
  forEach(t) {
    ge(this.inner, (e2, n) => {
...
function hs(...t) {
  let e2 = as;
  for (const n of t)
    e2 = e2.insert(n.key, n);
  return e2;
}
function ls(t) {
  let e2 = as;
  return t.forEach((t2, n) => e2 = e2.insert(t2, n.overlayedDocument)), e2;
}
function fs() {
  return ws();
}
...
function ws() {
  return new os((t) => t.toString(), (t, e2) => t.isEqual(e2));
}
...
function vs(t, e2, n) {
  return t instanceof bs ? function(t2, e3) {
    const n2 = {
      fields: {
        __type__: {
    ...
    return e3 && Ne(e3) && (e3 = ke(e3)), e3 && (n2.fields.__previous_value__ = e3), {
      mapValue: n2
    };
  }(n, e2) : t instanceof Vs ? Ss(t, e2) : t instanceof Ds ? Cs(t, e2) : function(t2, e3) {
    const n2 = Ps(t2, e3), s = Ns(n2) + Ns(t2.gt);
    return He(n2) && He(t2.gt) ? Ts(s) : Is(t2.serializer, s);
  }(t, e2);
}
function Rs(t, e2, n) {
  return t instanceof Vs ? Ss(t, e2) : t instanceof Ds ? Cs(t, e2) : n;
}
function Ps(t, e2) {
  return t instanceof xs ? He(n = e2) || function(t2) {
...
function Ss(t, e2) {
  const n = ks(e2);
  for (const e3 of t.elements)
    n.some((t2) => qe(t2, e3)) || n.push(e3);
  return {
    arrayValue: {
      values: n
    }
...
class xs extends As {
  constructor(t, e2) {
    super(), this.serializer = t, this.gt = e2;
  }
}
function Ns(t) {
...
class Ms {
  constructor(t, e2) {
    this.field = t, this.transform = e2;
  }
}
function $s(t, e2) {
  return t.field.isEqual(e2.field) && function(t2, e3) {
    return t2 instanceof Vs && e3 instanceof Vs || t2 instanceof Ds && e3 instanceof Ds ? nt(t2.elements, e3.elements, qe) : t2 instanceof xs && e3 instanceof xs ? qe(t2.gt, e3.gt) : t2 instanceof bs && e3 instanceof bs;
  }(t.transform, e2.transform);
}
class Os {
  constructor(t, e2) {
    this.version = t, this.transformResults = e2;
  }
}
class Fs {
  constructor(t, e2) {
    this.updateTime = t, this.exists = e2;
  }
  static none() {
    return new Fs();
  }
...
function Bs(t, e2) {
  return void 0 !== t.updateTime ? e2.isFoundDocument() && e2.version.isEqual(t.updateTime) : void 0 === t.exists || t.exists === e2.isFoundDocument();
}
class Ls {
}
function qs(t, e2) {
  if (!t.hasLocalMutations || e2 && 0 === e2.fields.length)
    return null;
  if (null === e2)
    return t.isNoDocument() ? new Ys(t.key, Fs.none()) : new js(t.key, t.data, Fs.none());
  {
    ...
    for (let t2 of e2.fields)
      if (!i.has(t2)) {
        let e3 = n.field(t2);
        null === e3 && t2.length > 1 && (t2 = t2.popLast(), e3 = n.field(t2)), null === e3 ? s.delete(t2) : s.set(t2, e3), i = i.add(t2);
      }
    return new zs(t.key, s, new Re(i.toArray()), Fs.none());
  }
}
function Us(t, e2, n) {
  t instanceof js ? function(t2, e3, n2) {
    const s = t2.value.clone(), i = Hs(t2.fieldTransforms, e3, n2.transformResults);
    s.setAll(i), e3.convertToFoundDocument(n2.version, s).setHasCommittedMutations();
  }(t, e2, n) : t instanceof zs ? function(t2, e3, n2) {
    if (!Bs(t2.precondition, e3))
      return void e3.convertToUnknownDocument(n2.version);
    const s = Hs(t2.fieldTransforms, e3, n2.transformResults), i = e3.data;
    i.setAll(Ws(t2)), i.setAll(s), e3.convertToFoundDocument(n2.version, i).setHasCommittedMutations();
  }(t, e2, n) : function(t2, e3, n2) {
    e3.convertToNoDocument(n2.version).setHasCommittedMutations();
  }(0, e2, n);
}
function Ks(t, e2, n, s) {
  return t instanceof js ? function(t2, e3, n2, s2) {
    if (!Bs(t2.precondition, e3))
      return n2;
    const i = t2.value.clone(), r2 = Js(t2.fieldTransforms, s2, e3);
    return i.setAll(r2), e3.convertToFoundDocument(e3.version, i).setHasLocalMutations(), null;
  }(t, e2, n, s) : t instanceof zs ? function(t2, e3, n2, s2) {
    if (!Bs(t2.precondition, e3))
      return n2;
    const i = Js(t2.fieldTransforms, s2, e3), r2 = e3.data;
    if (r2.setAll(Ws(t2)), r2.setAll(i), e3.convertToFoundDocument(e3.version, r2).setHasLocalMutations(), null === n2)
      return null;
    return n2.unionWith(t2.fieldMask.fields).unionWith(t2.fieldTransforms.map((t3) => t3.field));
  }(t, e2, n, s) : function(t2, e3, n2) {
    if (Bs(t2.precondition, e3))
...
function Gs(t, e2) {
  ...
  for (const s of t.fieldTransforms) {
    const t2 = e2.data.field(s.field), i = Ps(s.transform, t2 || null);
    null != i && (null === n && (n = un.empty()), n.set(s.field, i));
  }
  return n || null;
}
function Qs(t, e2) {
  return t.type === e2.type && (!!t.key.isEqual(e2.key) && (!!t.precondition.isEqual(e2.precondition) && (!!function(t2, e3) {
    return void 0 === t2 && void 0 === e3 || !(!t2 || !e3) && nt(t2, e3, (t3, e4) => $s(t3, e4));
  }(t.fieldTransforms, e2.fieldTransforms) && (0 === t.type ? t.value.isEqual(e2.value) : 1 !== t.type || t.data.isEqual(e2.data) && t.fieldMask.isEqual(e2.fieldMask)))));
}
class js extends Ls {
  constructor(t, e2, n, s = []) {
    super(), this.key = t, this.value = e2, this.precondition = n, this.fieldTransforms = s, this.type = 0;
  }
  getFieldMask() {
    return null;
  }
...
class zs extends Ls {
  constructor(t, e2, n, s, i = []) {
    super(), this.key = t, this.data = e2, this.fieldMask = n, this.precondition = s, this.fieldTransforms = i, this.type = 1;
  }
  getFieldMask() {
...
function Hs(t, e2, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r2 = t[i], o = r2.transform, u = e2.data.field(r2.field);
...
function Js(t, e2, n) {
  ...
  for (const i of t) {
    ...
    s.set(i.field, vs(t2, r2, e2));
  }
  return s;
}
class Ys extends Ls {
  constructor(t, e2) {
    super(), this.key = t, this.precondition = e2, this.type = 2, this.fieldTransforms = [];
  }
  getFieldMask() {
    return null;
  }
...
class Xs extends Ls {
  constructor(t, e2) {
    super(), this.key = t, this.precondition = e2, this.type = 3, this.fieldTransforms = [];
  }
  getFieldMask() {
    return null;
  }
...
class Zs {
  constructor(t, e2, n, s) {
    this.batchId = t, this.localWriteTime = e2, this.baseMutations = n, this.mutations = s;
  }
  applyToRemoteDocument(t, e2) {
    const n = e2.mutationResults;
    for (let e3 = 0; e3 < this.mutations.length; e3++) {
      const s = this.mutations[e3];
      if (s.key.isEqual(t.key)) {
        Us(s, t, n[e3]);
      }
    }
  }
  applyToLocalView(t, e2) {
    for (const n of this.baseMutations)
      n.key.isEqual(t.key) && (e2 = Ks(n, t, e2, this.localWriteTime));
    for (const n of this.mutations)
      n.key.isEqual(t.key) && (e2 = Ks(n, t, e2, this.localWriteTime));
    return e2;
  }
  applyToLocalDocumentSet(t, e2) {
    const n = ds();
    return this.mutations.forEach((s) => {
      const i = t.get(s.key), r2 = i.overlayedDocument;
      let o = this.applyToLocalView(r2, i.mutatedFields);
      o = e2.has(s.key) ? null : o;
      const u = qs(r2, o);
      null !== u && n.set(s.key, u), r2.isValidDocument() || r2.convertToNoDocument(rt.min());
    }), n;
  }
  keys() {
    return this.mutations.reduce((t, e2) => t.add(e2.key), gs());
  }
  isEqual(t) {
    return this.batchId === t.batchId && nt(this.mutations, t.mutations, (t2, e2) => Qs(t2, e2)) && nt(this.baseMutations, t.baseMutations, (t2, e2) => Qs(t2, e2));
  }
}
class ti {
  constructor(t, e2, n, s) {
    this.batch = t, this.commitVersion = e2, this.mutationResults = n, this.docVersions = s;
  }
  static from(t, e2, n) {
...
class ei {
  constructor(t, e2) {
    this.largestBatchId = t, this.mutation = e2;
  }
  getKey() {
...
class si {
  constructor(t, e2) {
    this.count = t, this.unchangedNames = e2;
  }
}
/**
 * @license
...
class ci {
  ...
  onExistenceFilterMismatch(t) {
    const e2 = Symbol();
    return this.onExistenceFilterMismatchCallbacks.set(e2, t), () => this.onExistenceFilterMismatchCallbacks.delete(e2);
  }
  notifyOnExistenceFilterMismatch(t) {
    this.onExistenceFilterMismatchCallbacks.forEach((e2) => e2(t));
  }
}
let ai = null;
/**
...
function fi(t) {
  const e2 = hi().encode(t), n = new Md5();
  return n.update(e2), new Uint8Array(n.digest());
}
function di(t) {
  const e2 = new DataView(t.buffer), n = e2.getUint32(0, true), s = e2.getUint32(4, true), i = e2.getUint32(8, true), r2 = e2.getUint32(12, true);
  return [new Integer([n, s], 0), new Integer([i, r2], 0)];
}
class wi {
  constructor(t, e2, n) {
    if (this.bitmap = t, this.padding = e2, this.hashCount = n, e2 < 0 || e2 >= 8)
      throw new _i(`Invalid padding: ${e2}`);
    if (n < 0)
      throw new _i(`Invalid hash count: ${n}`);
    if (t.length > 0 && 0 === this.hashCount)
      throw new _i(`Invalid hash count: ${n}`);
    if (0 === t.length && 0 !== e2)
      throw new _i(`Invalid padding when bitmap length is 0: ${e2}`);
    this.It = 8 * t.length - e2, this.Tt = Integer.fromNumber(this.It);
  }
  Et(t, e2, n) {
    let s = t.add(e2.multiply(Integer.fromNumber(n)));
  ...
  vt(t) {
    if (0 === this.It)
      return false;
    const e2 = fi(t), [n, s] = di(e2);
    for (let t2 = 0; t2 < this.hashCount; t2++) {
      const e3 = this.Et(n, s, t2);
      if (!this.At(e3))
        return false;
    }
    return true;
  ...
  static create(t, e2, n) {
    const s = t % 8 == 0 ? 0 : 8 - t % 8, i = new Uint8Array(Math.ceil(t / 8)), r2 = new wi(i, s, e2);
...
class mi {
  constructor(t, e2, n, s, i) {
    this.snapshotVersion = t, this.targetChanges = e2, this.targetMismatches = n, this.documentUpdates = s, this.resolvedLimboDocuments = i;
  }
  static createSynthesizedRemoteEventForCurrentChange(t, e2, n) {
    const s = /* @__PURE__ */ new Map();
    return s.set(t, gi.createSynthesizedTargetChangeForCurrentChange(t, e2, n)), new mi(rt.min(), s, new pe(et), cs(), gs());
  }
}
class gi {
  constructor(t, e2, n, s, i) {
    this.resumeToken = t, this.current = e2, this.addedDocuments = n, this.modifiedDocuments = s, this.removedDocuments = i;
  }
  static createSynthesizedTargetChangeForCurrentChange(t, e2, n) {
    return new gi(n, e2, gs(), gs(), gs());
  }
}
/**
 * @license
...
class yi {
  constructor(t, e2, n, s) {
    this.Pt = t, this.removedTargetIds = e2, this.key = n, this.bt = s;
  }
}
class pi {
  constructor(t, e2) {
    this.targetId = t, this.Vt = e2;
  }
}
class Ii {
  constructor(t, e2, n = Ve.EMPTY_BYTE_STRING, s = null) {
    this.state = t, this.targetIds = e2, this.resumeToken = n, this.cause = s;
  }
}
class Ti {
  constructor() {
  ...
  Ot() {
    ...
    }), new gi(this.Ct, this.xt, t, e2, n);
  }
  Ft() {
    this.Nt = false, this.Dt = vi();
  }
  Bt(t, e2) {
    this.Nt = true, this.Dt = this.Dt.insert(t, e2);
  }
  Lt(t) {
...
class Ei {
  ...
  Ht(t) {
    for (const e2 of t.Pt)
      t.bt && t.bt.isFoundDocument() ? this.Jt(e2, t.bt) : this.Yt(e2, t.key, t.bt);
    for (const e2 of t.removedTargetIds)
      this.Yt(e2, t.key, t.bt);
  }
  Xt(t) {
    this.forEachTarget(t, (e2) => {
      const n = this.Zt(e2);
      switch (t.state) {
        case 0:
          this.te(e2) && n.$t(t.resumeToken);
          break;
        case 1:
          n.Ut(), n.kt || n.Ft(), n.$t(t.resumeToken);
          break;
        case 2:
          n.Ut(), n.kt || this.removeTarget(e2);
          break;
        case 3:
          this.te(e2) && (n.Kt(), n.$t(t.resumeToken));
          break;
        case 4:
          this.te(e2) && (this.ee(e2), n.$t(t.resumeToken));
          break;
        default:
          O();
      }
  ...
  forEachTarget(t, e2) {
    t.targetIds.length > 0 ? t.targetIds.forEach(e2) : this.Qt.forEach((t2, n) => {
      this.te(n) && e2(n);
    });
  }
  ne(t) {
    ...
    if (i) {
      ...
      if (Fn(r2))
        ...
        if (i2 !== s) {
          ...
          null === (e2 = ci.instance) || void 0 === e2 || e2.notifyOnExistenceFilterMismatch(function(t2, e3, n2) {
            var s3, i3, r3, o, u, c;
            const a = {
              localCacheCount: e3,
  ...
  re(t, e2) {
    ...
    if (0 === c.It)
      return 1;
    return s !== e2 - this.oe(t.targetId, c) ? 2 : 0;
  }
  oe(t, e2) {
    ...
    this.Qt.forEach((n2, s2) => {
      ...
      if (i) {
        if (n2.current && Fn(i.target)) {
          const e3 = new ht(i.target.path);
          null !== this.jt.get(e3) || this.ae(s2, e3) || this.Yt(s2, e3, an.newNoDocument(e3, t));
        }
        n2.Mt && (e2.set(s2, n2.Ot()), n2.Ft());
      }
    });
    let n = gs();
    this.zt.forEach((t2, e3) => {
      let s2 = true;
      e3.forEachWhile((t3) => {
        const e4 = this.se(t3);
        return !e4 || "TargetPurposeLimboResolution" === e4.purpose || (s2 = false, false);
      }), s2 && (n = n.add(t2));
    }), this.jt.forEach((e3, n2) => n2.setReadTime(t));
    const s = new mi(t, e2, this.Wt, this.jt, n);
    return this.jt = cs(), this.zt = Ai(), this.Wt = new pe(et), s;
  }
  Jt(t, e2) {
    if (!this.te(t))
      return;
    const n = this.ae(t, e2.key) ? 2 : 0;
    this.Zt(t).Bt(e2.key, n), this.jt = this.jt.insert(e2.key, e2), this.zt = this.zt.insert(e2.key, this.he(e2.key).add(t));
  }
  Yt(t, e2, n) {
    if (!this.te(t))
      return;
    const s = this.Zt(t);
    this.ae(t, e2) ? s.Bt(e2, 1) : s.Lt(e2), this.zt = this.zt.insert(e2, this.he(e2).delete(t)), n && (this.jt = this.jt.insert(e2, n));
  }
  removeTarget(t) {
    this.Qt.delete(t);
  }
  ie(t) {
    const e2 = this.Zt(t).Ot();
    return this.Gt.getRemoteKeysForTarget(t).size + e2.addedDocuments.size - e2.removedDocuments.size;
  }
  qt(t) {
    this.Zt(t).qt();
  }
  Zt(t) {
    let e2 = this.Qt.get(t);
    return e2 || (e2 = new Ti(), this.Qt.set(t, e2)), e2;
  }
  he(t) {
    let e2 = this.zt.get(t);
    return e2 || (e2 = new Ee(et), this.zt = this.zt.insert(t, e2)), e2;
  }
  te(t) {
    const e2 = null !== this.se(t);
    return e2 || N("WatchChangeAggregator", "Detected inactive target", t), e2;
  }
  se(t) {
    const e2 = this.Qt.get(t);
    return e2 && e2.kt ? null : this.Gt.le(t);
  }
  ee(t) {
    this.Qt.set(t, new Ti());
    this.Gt.getRemoteKeysForTarget(t).forEach((e2) => {
      this.Yt(t, e2, null);
    });
  }
  ae(t, e2) {
    return this.Gt.getRemoteKeysForTarget(t).has(e2);
  }
}
function Ai() {
...
class Vi {
  constructor(t, e2) {
    this.databaseId = t, this.useProto3Json = e2;
  }
}
function Si(t, e2) {
  return t.useProto3Json || Ft(e2) ? e2 : {
    value: e2
  };
}
function Di(t, e2) {
...
function Ci(t, e2) {
  return t.useProto3Json ? e2.toBase64() : e2.toUint8Array();
}
function xi(t, e2) {
  return Di(t, e2.toTimestamp());
}
function Ni(t) {
...
function ki(t, e2) {
  ...
  }(t).child("documents").child(e2).canonicalString();
}
function Mi(t) {
  const e2 = ut.fromString(t);
  return F(ur(e2)), e2;
}
function $i(t, e2) {
  return ki(t.databaseId, e2.path);
}
function Oi(t, e2) {
  const n = Mi(e2);
...
function Fi(t, e2) {
  return ki(t.databaseId, e2);
}
function Bi(t) {
  const e2 = Mi(t);
  return 4 === e2.length ? ut.emptyPath() : qi(e2);
}
function Li(t) {
...
function Qi(t, e2) {
  ...
  if ("targetChange" in e2) {
    ...
    }(e2.targetChange.targetChangeType || "NO_CHANGE"), i = e2.targetChange.targetIds || [], r2 = function(t2, e3) {
      return t2.useProto3Json ? (F(void 0 === e3 || "string" == typeof e3), Ve.fromBase64String(e3 || "")) : (F(void 0 === e3 || e3 instanceof Uint8Array), Ve.fromUint8Array(e3 || new Uint8Array()));
    }(t, e2.targetChange.resumeToken), o = e2.targetChange.cause, u = o && function(t2) {
      const e3 = void 0 === t2.code ? q.UNKNOWN : ui(t2.code);
      return new U(e3, t2.message || "");
    }(o);
    n = new Ii(s, i, r2, u || null);
  } else if ("documentChange" in e2) {
    e2.documentChange;
    const s = e2.documentChange;
...
function ji(t, e2) {
  ...
  if (e2 instanceof js)
    n = {
      update: Ui(t, e2.key, e2.value)
    };
  else if (e2 instanceof Ys)
    n = {
      delete: $i(t, e2.key)
    };
  else if (e2 instanceof zs)
    n = {
      update: Ui(t, e2.key, e2.data),
      updateMask: or(e2.fieldMask)
    };
  else {
    if (!(e2 instanceof Xs))
      return O();
  ...
  return e2.fieldTransforms.length > 0 && (n.updateTransforms = e2.fieldTransforms.map((t2) => function(t3, e3) {
    const n2 = e3.transform;
    if (n2 instanceof bs)
      return {
    ...
    throw O();
  }(0, t2))), e2.precondition.isNone || (n.currentDocument = function(t2, e3) {
    return void 0 !== e3.updateTime ? {
      updateTime: xi(t2, e3.updateTime)
    } : void 0 !== e3.exists ? {
      exists: e3.exists
    } : O();
  }(t, e2.precondition)), n;
...
function Wi(t, e2) {
  return t && t.length > 0 ? (F(void 0 !== e2), t.map((t2) => function(t3, e3) {
    let n = t3.updateTime ? Ni(t3.updateTime) : Ni(e3);
    return n.isEqual(rt.min()) && (n = Ni(e3)), new Os(n, t3.transformResults || []);
  }(t2, e2))) : [];
}
function Hi(t, e2) {
  return {
    documents: [Fi(t, e2.path)]
  };
}
function Ji(t, e2) {
  const n = {
  ...
  null !== e2.collectionGroup ? (n.parent = Fi(t, s), n.structuredQuery.from = [{
  ...
  const o = Si(t, e2.limit);
  var u;
  return null !== o && (n.structuredQuery.limit = o), e2.startAt && (n.structuredQuery.startAt = {
    before: (u = e2.startAt).inclusive,
    values: u.position
  }), e2.endAt && (n.structuredQuery.endAt = function(t2) {
    return {
      before: !t2.inclusive,
      values: t2.position
    };
...
function Yi(t) {
  ...
  if (s > 0) {
    F(1 === s);
    const t2 = n.from[0];
    t2.allDescendants ? i = t2.collectionId : e2 = e2.child(t2.collectionId);
  }
  let r2 = [];
  n.where && (r2 = function(t2) {
    const e3 = Zi(t2);
    if (e3 instanceof gn && In(e3))
      return e3.getFilters();
    return [e3];
  }(n.where));
  let o = [];
  ...
  n.limit && (u = function(t2) {
    let e3;
    return e3 = "object" == typeof t2 ? t2.value : t2, Ft(e3) ? null : e3;
  }(n.limit));
  let c = null;
  n.startAt && (c = function(t2) {
    const e3 = !!t2.before, n2 = t2.values || [];
    return new hn(n2, e3);
  }(n.startAt));
  let a = null;
...
function Zi(t) {
  return void 0 !== t.unaryFilter ? function(t2) {
    switch (t2.unaryFilter.op) {
      case "IS_NAN":
        const e2 = ir(t2.unaryFilter.field);
        return mn.create(e2, "==", {
          doubleValue: NaN
        });
      case "IS_NULL":
...
function rr(t) {
  return t instanceof mn ? function(t2) {
    ...
    const e2 = t2.getFilters().map((t3) => rr(t3));
    if (1 === e2.length)
      return e2[0];
    return {
      compositeFilter: {
...
function or(t) {
  const e2 = [];
  return t.fields.forEach((t2) => e2.push(t2.canonicalString())), {
    fieldPaths: e2
  };
}
function ur(t) {
 ...
 */
class cr {
  constructor(t, e2, n, s, i = rt.min(), r2 = rt.min(), o = Ve.EMPTY_BYTE_STRING, u = null) {
    this.target = t, this.targetId = e2, this.purpose = n, this.sequenceNumber = s, this.snapshotVersion = i, this.lastLimboFreeSnapshotVersion = r2, this.resumeToken = o, this.expectedCount = u;
  }
...
function yr(t) {
  ...
  return "LAST" === t.limitType ? Xn(e2, e2.limit, "L") : e2;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
class zr {
  ...
  addToCollectionParentIndex(t, e2) {
    return this.rn.add(e2), Rt.resolve();
  }
  getCollectionParents(t, e2) {
    return Rt.resolve(this.rn.getEntries(e2));
  }
  addFieldIndex(t, e2) {
    return Rt.resolve();
  }
  deleteFieldIndex(t, e2) {
    return Rt.resolve();
  }
  getDocumentsMatchingTarget(t, e2) {
    return Rt.resolve(null);
  }
  getIndexType(t, e2) {
    return Rt.resolve(0);
  }
  getFieldIndexes(t, e2) {
    return Rt.resolve([]);
  }
  ...
  getMinOffsetFromCollectionGroup(t, e2) {
    return Rt.resolve(It.min());
  }
  updateCollectionGroup(t, e2, n) {
    return Rt.resolve();
  }
  updateIndexEntries(t, e2) {
    return Rt.resolve();
  }
}
class Wr {
  ...
  add(t) {
    const e2 = t.lastSegment(), n = t.popLast(), s = this.index[e2] || new Ee(ut.comparator), i = !s.has(n);
    return this.index[e2] = s.add(n), i;
  }
  has(t) {
    const e2 = t.lastSegment(), n = t.popLast(), s = this.index[e2];
    return s && s.has(n);
  }
  getEntries(t) {
...
class vo {
  constructor() {
    this.changes = new os((t) => t.toString(), (t, e2) => t.isEqual(e2)), this.changesApplied = false;
  }
  addEntry(t) {
    this.assertNotApplied(), this.changes.set(t.key, t);
  }
  removeEntry(t, e2) {
    this.assertNotApplied(), this.changes.set(t, an.newInvalidDocument(t).setReadTime(e2));
  }
  getEntry(t, e2) {
    this.assertNotApplied();
    const n = this.changes.get(e2);
    return void 0 !== n ? Rt.resolve(n) : this.getFromCache(t, e2);
  }
  getEntries(t, e2) {
    return this.getAllFromCache(t, e2);
  }
  apply(t) {
...
class No {
  constructor(t, e2) {
    this.overlayedDocument = t, this.mutatedFields = e2;
  }
}
/**
 * @license
...
class ko {
  constructor(t, e2, n, s) {
    this.remoteDocumentCache = t, this.mutationQueue = e2, this.documentOverlayCache = n, this.indexManager = s;
  }
  getDocument(t, e2) {
    let n = null;
    return this.documentOverlayCache.getOverlay(t, e2).next((s) => (n = s, this.remoteDocumentCache.getEntry(t, e2))).next((t2) => (null !== n && Ks(n.mutation, t2, Re.empty(), it.now()), t2));
  }
  getDocuments(t, e2) {
    return this.remoteDocumentCache.getEntries(t, e2).next((e3) => this.getLocalViewOfDocuments(t, e3, gs()).next(() => e3));
  }
  getLocalViewOfDocuments(t, e2, n = gs()) {
    const s = fs();
    return this.populateOverlays(t, s, e2).next(() => this.computeViews(t, e2, s, n).next((t2) => {
      let e3 = hs();
      return t2.forEach((t3, n2) => {
        e3 = e3.insert(t3, n2.overlayedDocument);
      }), e3;
    }));
  }
  getOverlayedDocuments(t, e2) {
    const n = fs();
    return this.populateOverlays(t, n, e2).next(() => this.computeViews(t, e2, n, gs()));
  }
  populateOverlays(t, e2, n) {
    const s = [];
    return n.forEach((t2) => {
      e2.has(t2) || s.push(t2);
  ...
  computeViews(t, e2, n, s) {
    let i = cs();
    const r2 = ws(), o = ws();
    return e2.forEach((t2, e3) => {
      const o2 = n.get(e3.key);
      s.has(e3.key) && (void 0 === o2 || o2.mutation instanceof zs) ? i = i.insert(e3.key, e3) : void 0 !== o2 ? (r2.set(e3.key, o2.mutation.getFieldMask()), Ks(o2.mutation, e3, o2.mutation.getFieldMask(), it.now())) : r2.set(e3.key, Re.empty());
    }), this.recalculateAndSaveOverlays(t, i).next((t2) => (t2.forEach((t3, e3) => r2.set(t3, e3)), e2.forEach((t3, e3) => {
      var n2;
      return o.set(t3, new No(e3, null !== (n2 = r2.get(t3)) && void 0 !== n2 ? n2 : null));
    }), o));
  }
  recalculateAndSaveOverlays(t, e2) {
    const n = ws();
    let s = new pe((t2, e3) => t2 - e3), i = gs();
    return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t, e2).next((t2) => {
      for (const i2 of t2)
        i2.keys().forEach((t3) => {
          const r2 = e2.get(t3);
          if (null === r2)
      ...
      for (; o.hasNext(); ) {
        ...
        c.forEach((t2) => {
          if (!i.has(t2)) {
            const s3 = qs(e2.get(t2), n.get(t2));
  ...
  recalculateAndSaveOverlaysForDocumentKeys(t, e2) {
    return this.remoteDocumentCache.getEntries(t, e2).next((e3) => this.recalculateAndSaveOverlays(t, e3));
  }
  getDocumentsMatchingQuery(t, e2, n) {
    return function(t2) {
      return ht.isDocumentKey(t2.path) && null === t2.collectionGroup && 0 === t2.filters.length;
    }(e2) ? this.getDocumentsMatchingDocumentQuery(t, e2.path) : Wn(e2) ? this.getDocumentsMatchingCollectionGroupQuery(t, e2, n) : this.getDocumentsMatchingCollectionQuery(t, e2, n);
  }
  getNextDocuments(t, e2, n, s) {
    return this.remoteDocumentCache.getAllFromCollectionGroup(t, e2, n, s).next((i) => {
      const r2 = s - i.size > 0 ? this.documentOverlayCache.getOverlaysForCollectionGroup(t, e2, n.largestBatchId, s - i.size) : Rt.resolve(fs());
      let o = -1, u = i;
      return r2.next((e3) => Rt.forEach(e3, (e4, n2) => (o < n2.largestBatchId && (o = n2.largestBatchId), i.get(e4) ? Rt.resolve() : this.remoteDocumentCache.getEntry(t, e4).next((t2) => {
        u = u.insert(e4, t2);
      }))).next(() => this.populateOverlays(t, e3, i)).next(() => this.computeViews(t, u, e3, gs())).next((t2) => ({
        batchId: o,
        changes: ls(t2)
      })));
    });
  }
  getDocumentsMatchingDocumentQuery(t, e2) {
    return this.getDocument(t, new ht(e2)).next((t2) => {
      let e3 = hs();
      return t2.isFoundDocument() && (e3 = e3.insert(t2.key, t2)), e3;
    });
  }
  getDocumentsMatchingCollectionGroupQuery(t, e2, n) {
    const s = e2.collectionGroup;
    let i = hs();
    return this.indexManager.getCollectionParents(t, s).next((r2) => Rt.forEach(r2, (r3) => {
      const o = function(t2, e3) {
        return new Un(
          e3,
          null,
  ...
  getDocumentsMatchingCollectionQuery(t, e2, n) {
    let s;
    return this.documentOverlayCache.getOverlaysForCollection(t, e2.path, n.largestBatchId).next((i) => (s = i, this.remoteDocumentCache.getDocumentsMatchingQuery(t, e2, n, s))).next((t2) => {
      s.forEach((e3, n3) => {
        const s2 = n3.getKey();
      ...
      return t2.forEach((t3, i) => {
        const r2 = s.get(t3);
        void 0 !== r2 && Ks(r2.mutation, i, Re.empty(), it.now()), ns(e2, i) && (n2 = n2.insert(t3, i));
      }), n2;
    });
  }
}
...
class Mo {
  ...
  getBundleMetadata(t, e2) {
    return Rt.resolve(this.cs.get(e2));
  }
  saveBundleMetadata(t, e2) {
    var n;
    return this.cs.set(e2.id, {
      id: (n = e2).id,
      version: n.version,
  ...
  getNamedQuery(t, e2) {
    return Rt.resolve(this.hs.get(e2));
  }
  saveNamedQuery(t, e2) {
    return this.hs.set(e2.name, function(t2) {
      return {
        name: t2.name,
...
class $o {
  ...
  getOverlay(t, e2) {
    return Rt.resolve(this.overlays.get(e2));
  }
  getOverlays(t, e2) {
    const n = fs();
    return Rt.forEach(e2, (e3) => this.getOverlay(t, e3).next((t2) => {
      null !== t2 && n.set(e3, t2);
    })).next(() => n);
  }
  saveOverlays(t, e2, n) {
  ...
  removeOverlaysForBatchId(t, e2, n) {
    const s = this.ls.get(n);
    return void 0 !== s && (s.forEach((t2) => this.overlays = this.overlays.remove(t2)), this.ls.delete(n)), Rt.resolve();
  }
  getOverlaysForCollection(t, e2, n) {
    const s = fs(), i = e2.length + 1, r2 = new ht(e2.child("")), o = this.overlays.getIteratorFrom(r2);
    for (; o.hasNext(); ) {
  ...
  getOverlaysForCollectionGroup(t, e2, n, s) {
    let i = new pe((t2, e3) => t2 - e3);
    const r2 = this.overlays.getIterator();
    for (; r2.hasNext(); ) {
      const t2 = r2.getNext().value;
      if (t2.getKey().getCollectionGroup() === e2 && t2.largestBatchId > n) {
        let e3 = i.get(t2.largestBatchId);
        null === e3 && (e3 = fs(), i = i.insert(t2.largestBatchId, e3)), e3.set(t2.getKey(), t2);
      }
    }
    const o = fs(), u = i.getIterator();
    for (; u.hasNext(); ) {
      if (u.getNext().value.forEach((t2, e3) => o.set(t2, e3)), o.size() >= s)
        break;
    }
    return Rt.resolve(o);
  }
  we(t, e2, n) {
    ...
    this.overlays = this.overlays.insert(n.key, new ei(e2, n));
    let i = this.ls.get(e2);
    void 0 === i && (i = gs(), this.ls.set(e2, i)), this.ls.set(e2, i.add(n.key));
  }
}
/**
 * @license
...
class Oo {
  ...
  gs(t, e2) {
    t.forEach((t2) => this.addReference(t2, e2));
  }
  removeReference(t, e2) {
    this.ys(new Fo(t, e2));
  }
  ps(t, e2) {
    t.forEach((t2) => this.removeReference(t2, e2));
  }
  Is(t) {
    const e2 = new ht(new ut([])), n = new Fo(e2, t), s = new Fo(e2, t + 1), i = [];
  ...
  Es(t) {
    const e2 = new ht(new ut([])), n = new Fo(e2, t), s = new Fo(e2, t + 1);
    let i = gs();
    return this.ws.forEachInRange([n, s], (t2) => {
      i = i.add(t2.key);
    }), i;
  ...
  containsKey(t) {
    const e2 = new Fo(t, 0), n = this.fs.firstAfterOrEqual(e2);
    return null !== n && t.isEqual(n.key);
  }
}
class Fo {
  constructor(t, e2) {
    this.key = t, this.As = e2;
  }
  static ds(t, e2) {
    return ht.comparator(t.key, e2.key) || et(t.As, e2.As);
  }
  static _s(t, e2) {
    return et(t.As, e2.As) || ht.comparator(t.key, e2.key);
  }
}
/**
 * @license
...
class Bo {
  constructor(t, e2) {
    this.indexManager = t, this.referenceDelegate = e2, this.mutationQueue = [], this.vs = 1, this.Rs = new Ee(Fo.ds);
  }
  checkEmpty(t) {
    return Rt.resolve(0 === this.mutationQueue.length);
  }
  addMutationBatch(t, e2, n, s) {
    const i = this.vs;
    this.vs++, this.mutationQueue.length > 0 && this.mutationQueue[this.mutationQueue.length - 1];
    const r2 = new Zs(i, e2, n, s);
    this.mutationQueue.push(r2);
    for (const e3 of s)
      this.Rs = this.Rs.add(new Fo(e3.key, i)), this.indexManager.addToCollectionParentIndex(t, e3.key.path.popLast());
    return Rt.resolve(r2);
  }
  lookupMutationBatch(t, e2) {
    return Rt.resolve(this.Ps(e2));
  }
  getNextMutationBatchAfterBatchId(t, e2) {
    const n = e2 + 1, s = this.bs(n), i = s < 0 ? 0 : s;
  ...
  getAllMutationBatchesAffectingDocumentKey(t, e2) {
    const n = new Fo(e2, 0), s = new Fo(e2, Number.POSITIVE_INFINITY), i = [];
    return this.Rs.forEachInRange([n, s], (t2) => {
      const e3 = this.Ps(t2.As);
      i.push(e3);
    }), Rt.resolve(i);
  }
  getAllMutationBatchesAffectingDocumentKeys(t, e2) {
    let n = new Ee(et);
    return e2.forEach((t2) => {
      const e3 = new Fo(t2, 0), s = new Fo(t2, Number.POSITIVE_INFINITY);
      this.Rs.forEachInRange([e3, s], (t3) => {
        n = n.add(t3.As);
      });
    }), Rt.resolve(this.Vs(n));
  }
  getAllMutationBatchesAffectingQuery(t, e2) {
    const n = e2.path, s = n.length + 1;
    let i = n;
    ht.isDocumentKey(i) || (i = i.child(""));
    const r2 = new Fo(new ht(i), 0);
    let o = new Ee(et);
    return this.Rs.forEachWhile((t2) => {
      const e3 = t2.key.path;
      return !!n.isPrefixOf(e3) && (e3.length === s && (o = o.add(t2.As)), true);
  ...
  removeMutationBatch(t, e2) {
    F(0 === this.Ss(e2.batchId, "removed")), this.mutationQueue.shift();
    let n = this.Rs;
    return Rt.forEach(e2.mutations, (s) => {
      const i = new Fo(s.key, e2.batchId);
  ...
  containsKey(t, e2) {
    const n = new Fo(e2, 0), s = this.Rs.firstAfterOrEqual(n);
    return Rt.resolve(e2.isEqual(s && s.key));
  }
...
class Lo {
  ...
  addEntry(t, e2) {
    const n = e2.key, s = this.docs.get(n), i = s ? s.size : 0, r2 = this.Ds(e2);
  ...
  removeEntry(t) {
    const e2 = this.docs.get(t);
    e2 && (this.docs = this.docs.remove(t), this.size -= e2.size);
  }
  getEntry(t, e2) {
    const n = this.docs.get(e2);
    return Rt.resolve(n ? n.document.mutableCopy() : an.newInvalidDocument(e2));
  }
  getEntries(t, e2) {
    let n = cs();
    return e2.forEach((t2) => {
      const e3 = this.docs.get(t2);
      n = n.insert(t2, e3 ? e3.document.mutableCopy() : an.newInvalidDocument(t2));
    }), Rt.resolve(n);
  }
  getDocumentsMatchingQuery(t, e2, n, s) {
    let i = cs();
    const r2 = e2.path, o = new ht(r2.child("")), u = this.docs.getIteratorFrom(o);
    for (; u.hasNext(); ) {
      const { key: t2, value: { document: o2 } } = u.getNext();
      if (!r2.isPrefixOf(t2.path))
        break;
      t2.path.length > r2.length + 1 || (Tt(pt(o2), n) <= 0 || (s.has(o2.key) || ns(e2, o2)) && (i = i.insert(o2.key, o2.mutableCopy())));
    }
    return Rt.resolve(i);
  }
  getAllFromCollectionGroup(t, e2, n, s) {
    O();
  }
  Cs(t, e2) {
    return Rt.forEach(this.docs, (t2) => e2(t2));
  }
  newChangeBuffer(t) {
    return new qo(this);
  }
...
class qo extends vo {
  ...
  applyChanges(t) {
    ...
    return this.changes.forEach((n, s) => {
      s.isValidDocument() ? e2.push(this.os.addEntry(t, s)) : this.os.removeEntry(n);
    }), Rt.waitFor(e2);
  }
  getFromCache(t, e2) {
    return this.os.getEntry(t, e2);
  }
  getAllFromCache(t, e2) {
    return this.os.getEntries(t, e2);
  }
}
/**
 * @license
...
class Uo {
  ...
  forEachTarget(t, e2) {
    return this.xs.forEach((t2, n) => e2(n)), Rt.resolve();
  }
  ...
  setTargetsMetadata(t, e2, n) {
    return n && (this.lastRemoteSnapshotVersion = n), e2 > this.Ns && (this.Ns = e2), Rt.resolve();
  }
  Fn(t) {
    this.xs.set(t.target, t);
    const e2 = t.targetId;
    e2 > this.highestTargetId && (this.Ms = new lo(e2), this.highestTargetId = e2), t.sequenceNumber > this.Ns && (this.Ns = t.sequenceNumber);
  }
  addTargetData(t, e2) {
    return this.Fn(e2), this.targetCount += 1, Rt.resolve();
  }
  updateTargetData(t, e2) {
    return this.Fn(e2), Rt.resolve();
  }
  removeTargetData(t, e2) {
    return this.xs.delete(e2.target), this.ks.Is(e2.targetId), this.targetCount -= 1, Rt.resolve();
  }
  removeTargets(t, e2, n) {
    let s = 0;
    const i = [];
    return this.xs.forEach((r2, o) => {
      o.sequenceNumber <= e2 && null === n.get(o.targetId) && (this.xs.delete(r2), i.push(this.removeMatchingKeysForTargetId(t, o.targetId)), s++);
    }), Rt.waitFor(i).next(() => s);
  }
  getTargetCount(t) {
  ...
  getTargetData(t, e2) {
    const n = this.xs.get(e2) || null;
    return Rt.resolve(n);
  }
  addMatchingKeys(t, e2, n) {
    return this.ks.gs(e2, n), Rt.resolve();
  }
  removeMatchingKeys(t, e2, n) {
    this.ks.ps(e2, n);
    const s = this.persistence.referenceDelegate, i = [];
    return s && e2.forEach((e3) => {
      i.push(s.markPotentiallyOrphaned(t, e3));
    }), Rt.waitFor(i);
  }
  removeMatchingKeysForTargetId(t, e2) {
    return this.ks.Is(e2), Rt.resolve();
  }
  getMatchingKeysForTargetId(t, e2) {
    const n = this.ks.Es(e2);
    return Rt.resolve(n);
  }
  containsKey(t, e2) {
    return Rt.resolve(this.ks.containsKey(e2));
  }
}
/**
 * @license
...
class Ko {
  constructor(t, e2) {
    ...
    this.indexManager = new zr(), this.remoteDocumentCache = function(t2) {
      return new Lo(t2);
    }((t2) => this.referenceDelegate.Ls(t2)), this.serializer = new ar(e2), this.qs = new Mo(this.serializer);
  }
  start() {
    return Promise.resolve();
  }
  ...
  getDocumentOverlayCache(t) {
    let e2 = this.overlays[t.toKey()];
    return e2 || (e2 = new $o(), this.overlays[t.toKey()] = e2), e2;
  }
  getMutationQueue(t, e2) {
    let n = this.$s[t.toKey()];
    return n || (n = new Bo(e2, this.referenceDelegate), this.$s[t.toKey()] = n), n;
  }
  getTargetCache() {
    return this.Bs;
  }
  ...
  Gs(t, e2) {
    return Rt.or(Object.values(this.$s).map((n) => () => n.containsKey(t, e2)));
  }
}
class Go extends At {
  constructor(t) {
...
class Qo {
  ...
  addReference(t, e2, n) {
    return this.Qs.addReference(n, e2), this.Ws.delete(n.toString()), Rt.resolve();
  }
  removeReference(t, e2, n) {
    return this.Qs.removeReference(n, e2), this.Ws.add(n.toString()), Rt.resolve();
  }
  markPotentiallyOrphaned(t, e2) {
    return this.Ws.add(e2.toString()), Rt.resolve();
  }
  removeTarget(t, e2) {
    this.Qs.Is(e2.targetId).forEach((t2) => this.Ws.add(t2.toString()));
    const n = this.persistence.getTargetCache();
    return n.getMatchingKeysForTargetId(t, e2.targetId).next((t2) => {
      t2.forEach((t3) => this.Ws.add(t3.toString()));
    }).next(() => n.removeTargetData(t, e2));
  }
  Us() {
  ...
  Ks(t) {
    ...
    return Rt.forEach(this.Ws, (n) => {
      ...
      return this.Hs(t, s).next((t2) => {
        t2 || e2.removeEntry(s, rt.min());
      });
    }).next(() => (this.js = null, e2.apply(t)));
  }
  updateLimboDocument(t, e2) {
    return this.Hs(t, e2).next((t2) => {
      t2 ? this.Ws.delete(e2.toString()) : this.Ws.add(e2.toString());
    });
  }
  Ls(t) {
    return 0;
  ...
  Hs(t, e2) {
    return Rt.or([() => Rt.resolve(this.Qs.containsKey(e2)), () => this.persistence.getTargetCache().containsKey(t, e2), () => this.persistence.Gs(t, e2)]);
  }
}
/**
 * @license
...
class tu {
  constructor(t, e2, n, s) {
    this.targetId = t, this.fromCache = e2, this.Fi = n, this.Bi = s;
  }
  static Li(t, e2) {
    let n = gs(), s = gs();
    for (const t2 of e2.docChanges)
      switch (t2.type) {
        case 0:
          n = n.add(t2.doc.key);
          break;
    ...
    return new tu(t, e2.fromCache, n, s);
  }
}
/**
 * @license
...
class eu {
  ...
  initialize(t, e2) {
    this.Ui = t, this.indexManager = e2, this.qi = true;
  }
  getDocumentsMatchingQuery(t, e2, n, s) {
    return this.Ki(t, e2).next((i) => i || this.Gi(t, e2, s, n)).next((n2) => n2 || this.Qi(t, e2));
  }
  Ki(t, e2) {
    if (Qn(e2))
      return Rt.resolve(null);
    let n = Jn(e2);
    return this.indexManager.getIndexType(t, n).next((s) => 0 === s ? null : (null !== e2.limit && 1 === s && (e2 = Xn(e2, null, "F"), n = Jn(e2)), this.indexManager.getDocumentsMatchingTarget(t, n).next((s2) => {
      const i = gs(...s2);
      return this.Ui.getDocuments(t, i).next((s3) => this.indexManager.getMinOffset(t, n).next((n2) => {
        const r2 = this.ji(e2, s3);
        return this.zi(e2, r2, i, n2.readTime) ? this.Ki(t, Xn(e2, null, "F")) : this.Wi(t, r2, e2, n2);
      }));
    })));
  }
  Gi(t, e2, n, s) {
    return Qn(e2) || s.isEqual(rt.min()) ? this.Qi(t, e2) : this.Ui.getDocuments(t, n).next((i) => {
      const r2 = this.ji(e2, i);
      return this.zi(e2, r2, n, s) ? this.Qi(t, e2) : (C() <= LogLevel.DEBUG && N("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), es(e2)), this.Wi(t, r2, e2, yt(s, -1)));
    });
  }
  ji(t, e2) {
    let n = new Ee(is(t));
    return e2.forEach((e3, s) => {
      ns(t, s) && (n = n.add(s));
    }), n;
  }
  zi(t, e2, n, s) {
    ...
    if (n.size !== e2.size)
      return true;
    const i = "F" === t.limitType ? e2.last() : e2.first();
    return !!i && (i.hasPendingWrites || i.version.compareTo(s) > 0);
  }
  Qi(t, e2) {
    return C() <= LogLevel.DEBUG && N("QueryEngine", "Using full collection scan to execute query:", es(e2)), this.Ui.getDocumentsMatchingQuery(t, e2, It.min());
  }
  Wi(t, e2, n, s) {
    return this.Ui.getDocumentsMatchingQuery(t, n, s).next((t2) => (e2.forEach((e3) => {
      t2 = t2.insert(e3.key, e3);
    }), t2));
  }
}
/**
...
class nu {
  constructor(t, e2, n, s) {
    this.persistence = t, this.Hi = e2, this.serializer = s, this.Ji = new pe(et), this.Yi = new os((t2) => $n(t2), On), this.Xi = /* @__PURE__ */ new Map(), this.Zi = t.getRemoteDocumentCache(), this.Bs = t.getTargetCache(), this.qs = t.getBundleCache(), this.tr(n);
  }
  tr(t) {
  ...
  collectGarbage(t) {
    return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (e2) => t.collect(e2, this.Ji));
  }
}
function su(t, e2, n, s) {
  return new nu(t, e2, n, s);
}
async function iu(t, e2) {
  const n = L(t);
  return await n.persistence.runTransaction("Handle user change", "readonly", (t2) => {
    let s;
    return n.mutationQueue.getAllMutationBatches(t2).next((i) => (s = i, n.tr(e2), n.mutationQueue.getAllMutationBatches(t2))).next((e3) => {
      const i = [], r2 = [];
      let o = gs();
      for (const t3 of s) {
        i.push(t3.batchId);
        for (const e4 of t3.mutations)
          o = o.add(e4.key);
      }
      for (const t3 of e3) {
        r2.push(t3.batchId);
...
function ru(t, e2) {
  ...
  return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (t2) => {
    const s = e2.batch.keys(), i = n.Zi.newChangeBuffer({
      trackRemovals: true
    });
    return function(t3, e3, n2, s2) {
      const i2 = n2.batch, r2 = i2.keys();
      let o = Rt.resolve();
      return r2.forEach((t4) => {
        o = o.next(() => s2.getEntry(e3, t4)).next((e4) => {
          const r3 = n2.docVersions.get(t4);
          F(null !== r3), e4.version.compareTo(r3) < 0 && (i2.applyToRemoteDocument(e4, n2), e4.isValidDocument() && (e4.setReadTime(n2.commitVersion), s2.addEntry(e4)));
        });
      }), o.next(() => t3.mutationQueue.removeMutationBatch(e3, i2));
    }(n, t2, e2, i).next(() => i.apply(t2)).next(() => n.mutationQueue.performConsistencyCheck(t2)).next(() => n.documentOverlayCache.removeOverlaysForBatchId(t2, s, e2.batch.batchId)).next(() => n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t2, function(t3) {
      let e3 = gs();
      for (let n2 = 0; n2 < t3.mutationResults.length; ++n2) {
        t3.mutationResults[n2].transformResults.length > 0 && (e3 = e3.add(t3.batch.mutations[n2].key));
      }
      return e3;
    }(e2))).next(() => n.localDocuments.getDocuments(t2, s));
  });
}
function ou(t) {
  const e2 = L(t);
  return e2.persistence.runTransaction("Get last remote snapshot version", "readonly", (t2) => e2.Bs.getLastRemoteSnapshotVersion(t2));
}
function uu(t, e2) {
  const n = L(t), s = e2.snapshotVersion;
  let i = n.Ji;
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t2) => {
    ...
    i = n.Ji;
    const o = [];
    e2.targetChanges.forEach((r3, u2) => {
      const c2 = i.get(u2);
      if (!c2)
        return;
      ...
      null !== e2.targetMismatches.get(u2) ? a = a.withResumeToken(Ve.EMPTY_BYTE_STRING, rt.min()).withLastLimboFreeSnapshotVersion(rt.min()) : r3.resumeToken.approximateByteSize() > 0 && (a = a.withResumeToken(r3.resumeToken, s)), i = i.insert(u2, a), function(t3, e3, n2) {
        if (0 === t3.resumeToken.approximateByteSize())
          return true;
        if (e3.snapshotVersion.toMicroseconds() - t3.snapshotVersion.toMicroseconds() >= 3e8)
          return true;
        return n2.addedDocuments.size + n2.modifiedDocuments.size + n2.removedDocuments.size > 0;
      }(c2, a, r3) && o.push(n.Bs.updateTargetData(t2, a));
    });
    let u = cs(), c = gs();
    if (e2.documentUpdates.forEach((s2) => {
      e2.resolvedLimboDocuments.has(s2) && o.push(n.persistence.referenceDelegate.updateLimboDocument(t2, s2));
    }), o.push(cu(t2, r2, e2.documentUpdates).next((t3) => {
      u = t3.nr, c = t3.sr;
    })), !s.isEqual(rt.min())) {
      const e3 = n.Bs.getLastRemoteSnapshotVersion(t2).next((e4) => n.Bs.setTargetsMetadata(t2, t2.currentSequenceNumber, s));
      o.push(e3);
    }
...
function cu(t, e2, n) {
  let s = gs(), i = gs();
  return n.forEach((t2) => s = s.add(t2)), e2.getEntries(t, s).next((t2) => {
    let s2 = cs();
    return n.forEach((n2, r2) => {
      const o = t2.get(n2);
      r2.isFoundDocument() !== o.isFoundDocument() && (i = i.add(n2)), r2.isNoDocument() && r2.version.isEqual(rt.min()) ? (e2.removeEntry(n2, r2.readTime), s2 = s2.insert(n2, r2)) : !o.isValidDocument() || r2.version.compareTo(o.version) > 0 || 0 === r2.version.compareTo(o.version) && o.hasPendingWrites ? (e2.addEntry(r2), s2 = s2.insert(n2, r2)) : N("LocalStore", "Ignoring outdated watch update for ", n2, ". Current version:", o.version, " Watch version:", r2.version);
    }), {
      nr: s2,
      sr: i
    };
...
function au(t, e2) {
  const n = L(t);
  return n.persistence.runTransaction("Get next mutation batch", "readonly", (t2) => (void 0 === e2 && (e2 = -1), n.mutationQueue.getNextMutationBatchAfterBatchId(t2, e2)));
}
function hu(t, e2) {
  const n = L(t);
  return n.persistence.runTransaction("Allocate target", "readwrite", (t2) => {
    let s;
    return n.Bs.getTargetData(t2, e2).next((i) => i ? (s = i, Rt.resolve(s)) : n.Bs.allocateTargetId(t2).next((i2) => (s = new cr(e2, i2, "TargetPurposeListen", t2.currentSequenceNumber), n.Bs.addTargetData(t2, s).next(() => s))));
  }).then((t2) => {
    const s = n.Ji.get(t2.targetId);
    return (null === s || t2.snapshotVersion.compareTo(s.snapshotVersion) > 0) && (n.Ji = n.Ji.insert(t2.targetId, t2), n.Yi.set(e2, t2.targetId)), t2;
  });
}
async function lu(t, e2, n) {
  const s = L(t), i = s.Ji.get(e2), r2 = n ? "readwrite" : "readwrite-primary";
  try {
    n || await s.persistence.runTransaction("Release target", r2, (t2) => s.persistence.referenceDelegate.removeTarget(t2, i));
  } catch (t2) {
    if (!Dt(t2))
      throw t2;
    N("LocalStore", `Failed to update sequence numbers for target ${e2}: ${t2}`);
  }
  s.Ji = s.Ji.remove(e2), s.Yi.delete(i.target);
}
function fu(t, e2, n) {
  const s = L(t);
  let i = rt.min(), r2 = gs();
  return s.persistence.runTransaction("Execute query", "readonly", (t2) => function(t3, e3, n2) {
    const s2 = L(t3), i2 = s2.Yi.get(n2);
    return void 0 !== i2 ? Rt.resolve(s2.Ji.get(i2)) : s2.Bs.getTargetData(e3, n2);
  }(s, t2, Jn(e2)).next((e3) => {
    if (e3)
      return i = e3.lastLimboFreeSnapshotVersion, s.Bs.getMatchingKeysForTargetId(t2, e3.targetId).next((t3) => {
        r2 = t3;
      });
  }).next(() => s.Hi.getDocumentsMatchingQuery(t2, e2, n ? i : rt.min(), n ? r2 : gs())).next((t3) => (_u(s, ss(e2), t3), {
    documents: t3,
    ir: r2
  })));
}
function _u(t, e2, n) {
  let s = t.Xi.get(e2) || rt.min();
  n.forEach((t2, e3) => {
    e3.readTime.compareTo(s) > 0 && (s = e3.readTime);
  }), t.Xi.set(e2, s);
}
class Ru {
  constructor() {
...
class bu {
  ...
  updateMutationState(t, e2, n) {
  }
  addLocalQueryTarget(t) {
    return this.Hr.lr(t), this.Jr[t] || "not-current";
  }
  updateQueryState(t, e2, n) {
    this.Jr[t] = e2;
  }
...
class Mu extends class {
  constructor(t) {
    ...
    const e2 = t.ssl ? "https" : "http";
    this.mo = e2 + "://" + t.host, this.yo = "projects/" + this.databaseId.projectId + "/databases/" + this.databaseId.database + "/documents";
  }
  get po() {
    return false;
  }
  Io(t, e2, n, s, i) {
    const r2 = Cu(), o = this.To(t, e2);
    N("RestConnection", `Sending RPC '${t}' ${r2}:`, o, n);
    const u = {};
    return this.Eo(u, s, i), this.Ao(t, o, u, n).then((e3) => (N("RestConnection", `Received RPC '${t}' ${r2}: `, e3), e3), (e3) => {
      throw M("RestConnection", `RPC '${t}' ${r2} failed with error: `, e3, "url: ", o, "request:", n), e3;
    });
  }
  vo(t, e2, n, s, i, r2) {
    return this.Io(t, e2, n, s, i);
  }
  Eo(t, e2, n) {
    t["X-Goog-Api-Client"] = "gl-js/ fire/" + S, t["Content-Type"] = "text/plain", this.databaseInfo.appId && (t["X-Firebase-GMPID"] = this.databaseInfo.appId), e2 && e2.headers.forEach((e3, n2) => t[n2] = e3), n && n.headers.forEach((e3, n2) => t[n2] = e3);
  }
  To(t, e2) {
    const n = xu[t];
    return `${this.mo}/v1/${e2}:${n}`;
  }
} {
  constructor(t) {
  ...
  Ao(t, e2, n, s) {
    ...
    return new Promise((r2, o) => {
        ...
        try {
          switch (u.getLastErrorCode()) {
            case ErrorCode.NO_ERROR:
              const e3 = u.getResponseJson();
              N(ku, `XHR for RPC '${t}' ${i} received:`, JSON.stringify(e3)), r2(e3);
              break;
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              if (N(ku, `RPC '${t}' ${i} failed with status:`, n2, "response text:", u.getResponseText()), n2 > 0) {
                ...
                const e4 = null == t2 ? void 0 : t2.error;
                if (e4 && e4.status && e4.message) {
                  const t3 = function(t4) {
                    const e5 = t4.toLowerCase().replace(/_/g, "-");
                    return Object.values(q).indexOf(e5) >= 0 ? e5 : q.UNKNOWN;
                  }(e4.status);
                  o(new U(t3, e4.message));
                } else
      ...
      N(ku, `RPC '${t}' ${i} sending request:`, s), u.send(e2, "POST", c, n, 15);
    });
  }
  Ro(t, e2, n) {
    ...
    void 0 !== c && (u.longPollingTimeout = Math.round(1e3 * c)), this.useFetchStreams && (u.xmlHttpFactory = new FetchXmlHttpFactory({})), this.Eo(u.initMessageHeaders, e2, n), u.encodeInitMessageHeaders = true;
    const a = i.join("");
    ...
    const d = new Nu({
      ro: (e3) => {
        f ? N(ku, `Not sending because RPC '${t}' stream ${s} is closed:`, e3) : (l2 || (N(ku, `Opening RPC '${t}' stream ${s} transport.`), h.open(), l2 = true), N(ku, `RPC '${t}' stream ${s} sending:`, e3), h.send(e3));
      },
      oo: () => h.close()
    }), w2 = (t2, e3, n2) => {
      t2.listen(e3, (t3) => {
    ...
    }), w2(h, WebChannel.EventType.ERROR, (e3) => {
      f || (f = true, M(ku, `RPC '${t}' stream ${s} transport errored:`, e3), d.wo(new U(q.UNAVAILABLE, "The operation could not be completed")));
    }), w2(h, WebChannel.EventType.MESSAGE, (e3) => {
      var n2;
      if (!f) {
        const i2 = e3.data[0];
        F(!!i2);
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = q.INTERNAL, i3 = "Unknown error status: " + e4 + " with message " + o2.message), f = true, d.wo(new U(n3, i3)), h.close();
        } else
          N(ku, `RPC '${t}' stream ${s} received:`, i2), d._o(i2);
      }
    }), w2(o, Event.STAT_EVENT, (e3) => {
      e3.stat === Stat.PROXY ? N(ku, `RPC '${t}' stream ${s} detected buffering proxy`) : e3.stat === Stat.NOPROXY && N(ku, `RPC '${t}' stream ${s} detected no buffering proxy`);
    }), setTimeout(() => {
      d.fo();
    }, 0), d;
  }
 ...
 */
class Bu {
  constructor(t, e2, n = 1e3, s = 1.5, i = 6e4) {
    this.ii = t, this.timerId = e2, this.Po = n, this.bo = s, this.Vo = i, this.So = 0, this.Do = null, this.Co = Date.now(), this.reset();
  }
  reset() {
    this.So = 0;
  }
  ...
  No(t) {
    this.cancel();
    const e2 = Math.floor(this.So + this.ko()), n = Math.max(0, Date.now() - this.Co), s = Math.max(0, e2 - n);
    s > 0 && N("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.So} ms, delay with jitter: ${e2} ms, last attempt: ${n} ms ago)`), this.Do = this.ii.enqueueAfterDelay(this.timerId, s, () => (this.Co = Date.now(), t())), this.So *= this.bo, this.So < this.Po && (this.So = this.Po), this.So > this.Vo && (this.So = this.Vo);
  }
  Mo() {
 ...
 */
class Lu {
  constructor(t, e2, n, s, i, r2, o, u) {
    this.ii = t, this.$o = n, this.Oo = s, this.connection = i, this.authCredentialsProvider = r2, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, this.Fo = 0, this.Bo = null, this.Lo = null, this.stream = null, this.qo = new Bu(t, e2);
  }
  Uo() {
  ...
  async close(t, e2) {
    this.Ho(), this.Jo(), this.qo.cancel(), this.Fo++, 4 !== t ? this.qo.reset() : e2 && e2.code === q.RESOURCE_EXHAUSTED ? (k(e2.toString()), k("Using maximum backoff delay to prevent overloading the backend."), this.qo.xo()) : e2 && e2.code === q.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.Yo(), this.stream.close(), this.stream = null), this.state = t, await this.listener.ao(e2);
  }
  Yo() {
  }
  auth() {
    this.state = 1;
    const t = this.Xo(this.Fo), e2 = this.Fo;
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([t2, n]) => {
      this.Fo === e2 && this.Zo(t2, n);
    }, (e3) => {
      t(() => {
        const t2 = new U(q.UNKNOWN, "Fetching auth token failed: " + e3.message);
        return this.tu(t2);
      });
    });
  }
  Zo(t, e2) {
    ...
    this.stream = this.eu(t, e2), this.stream.uo(() => {
  ...
  Xo(t) {
    return (e2) => {
      this.ii.enqueueAndForget(() => this.Fo === t ? e2() : (N("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
}
class qu extends Lu {
  constructor(t, e2, n, s, i, r2) {
    super(t, "listen_stream_connection_backoff", "listen_stream_idle", "health_check_timeout", e2, n, s, r2), this.serializer = i;
  }
  eu(t, e2) {
    return this.connection.Ro("Listen", t, e2);
  }
  onMessage(t) {
    this.qo.reset();
    const e2 = Qi(this.serializer, t), n = function(t2) {
      if (!("targetChange" in t2))
        return rt.min();
      const e3 = t2.targetChange;
      return e3.targetIds && e3.targetIds.length ? rt.min() : e3.readTime ? Ni(e3.readTime) : rt.min();
    }(t);
    return this.listener.nu(e2, n);
  }
  su(t) {
    const e2 = {};
    e2.database = Li(this.serializer), e2.addTarget = function(t2, e3) {
      let n2;
      const s = e3.target;
      if (n2 = Fn(s) ? {
        documents: Hi(t2, s)
        ...
        query: Ji(t2, s)
      }, n2.targetId = e3.targetId, e3.resumeToken.approximateByteSize() > 0) {
        n2.resumeToken = Ci(t2, e3.resumeToken);
        const s2 = Si(t2, e3.expectedCount);
        null !== s2 && (n2.expectedCount = s2);
      } else if (e3.snapshotVersion.compareTo(rt.min()) > 0) {
        n2.readTime = Di(t2, e3.snapshotVersion.toTimestamp());
        const s2 = Si(t2, e3.expectedCount);
        null !== s2 && (n2.expectedCount = s2);
      }
      return n2;
    ...
    n && (e2.labels = n), this.Wo(e2);
  }
  iu(t) {
    const e2 = {};
    e2.database = Li(this.serializer), e2.removeTarget = t, this.Wo(e2);
  }
}
class Uu extends Lu {
  constructor(t, e2, n, s, i, r2) {
    super(t, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", e2, n, s, r2), this.serializer = i, this.ru = false;
  }
  get ou() {
    return this.ru;
  }
  ...
  eu(t, e2) {
    return this.connection.Ro("Write", t, e2);
  }
  onMessage(t) {
    if (F(!!t.streamToken), this.lastStreamToken = t.streamToken, this.ru) {
      this.qo.reset();
      const e2 = Wi(t.writeResults, t.commitTime), n = Ni(t.commitTime);
      return this.listener.cu(n, e2);
    }
...
class Ku extends class {
  ...
  constructor(t, e2, n, s) {
    super(), this.authCredentials = t, this.appCheckCredentials = e2, this.connection = n, this.serializer = s, this.lu = false;
  }
  fu() {
    if (this.lu)
  ...
  Io(t, e2, n) {
    return this.fu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.connection.Io(t, e2, n, s, i)).catch((t2) => {
  ...
  vo(t, e2, n, s) {
    return this.fu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, r2]) => this.connection.vo(t, e2, n, i, r2, s)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === q.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new U(q.UNKNOWN, t2.toString());
    });
  }
  terminate() {
...
class Qu {
  constructor(t, e2) {
    this.asyncQueue = t, this.onlineStateHandler = e2, this.state = "Unknown", this.wu = 0, this._u = null, this.mu = true;
  }
  gu() {
  ...
  pu(t) {
    const e2 = `Could not reach Cloud Firestore backend. ${t}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.mu ? (k(e2), this.mu = false) : N("OnlineStateTracker", e2);
  }
  Tu() {
...
class ju {
  constructor(t, e2, n, s, i) {
    this.localStore = t, this.datastore = e2, this.asyncQueue = n, this.remoteSyncer = {}, this.Eu = [], this.Au = /* @__PURE__ */ new Map(), this.vu = /* @__PURE__ */ new Set(), this.Ru = [], this.Pu = i, this.Pu.Yr((t2) => {
      n.enqueueAndForget(async () => {
        ec(this) && (N("RemoteStore", "Restarting streams for network reachability change."), await async function(t3) {
          const e3 = L(t3);
          e3.vu.add(4), await Wu(e3), e3.bu.set("Unknown"), e3.vu.delete(4), await zu(e3);
        }(this));
      });
    }), this.bu = new Qu(n, s);
  }
...
function Hu(t, e2) {
  const n = L(t);
  n.Au.has(e2.targetId) || (n.Au.set(e2.targetId, e2), tc(n) ? Zu(n) : pc(n).Ko() && Yu(n, e2));
}
function Ju(t, e2) {
  const n = L(t), s = pc(n);
  n.Au.delete(e2), s.Ko() && Xu(n, e2), 0 === n.Au.size && (s.Ko() ? s.jo() : ec(n) && n.bu.set("Unknown"));
}
function Yu(t, e2) {
  if (t.Vu.qt(e2.targetId), e2.resumeToken.approximateByteSize() > 0 || e2.snapshotVersion.compareTo(rt.min()) > 0) {
    const n = t.remoteSyncer.getRemoteKeysForTarget(e2.targetId).size;
    e2 = e2.withExpectedCount(n);
  }
  pc(t).su(e2);
}
function Xu(t, e2) {
  t.Vu.qt(e2), pc(t).iu(e2);
}
function Zu(t) {
  t.Vu = new Ei({
    getRemoteKeysForTarget: (e2) => t.remoteSyncer.getRemoteKeysForTarget(e2),
    le: (e2) => t.Au.get(e2) || null,
...
async function ic(t, e2) {
  nc(t), tc(t) ? (t.bu.Iu(e2), Zu(t)) : t.bu.set("Unknown");
}
async function rc(t, e2, n) {
  if (t.bu.set("Online"), e2 instanceof Ii && 2 === e2.state && e2.cause)
    try {
      await async function(t2, e3) {
        const n2 = e3.cause;
        for (const s of e3.targetIds)
          t2.Au.has(s) && (await t2.remoteSyncer.rejectListen(s, n2), t2.Au.delete(s), t2.Vu.removeTarget(s));
      }(t, e2);
    } catch (n2) {
      N("RemoteStore", "Failed to remove targets %s: %s ", e2.targetIds.join(","), n2), await oc(t, n2);
    }
  else if (e2 instanceof yi ? t.Vu.Ht(e2) : e2 instanceof pi ? t.Vu.ne(e2) : t.Vu.Xt(e2), !n.isEqual(rt.min()))
    try {
      const e3 = await ou(t.localStore);
      n.compareTo(e3) >= 0 && await function(t2, e4) {
        const n2 = t2.Vu.ce(e4);
        return n2.targetChanges.forEach((n3, s) => {
          if (n3.resumeToken.approximateByteSize() > 0) {
            const i = t2.Au.get(s);
            i && t2.Au.set(s, i.withResumeToken(n3.resumeToken, e4));
          }
        }), n2.targetMismatches.forEach((e5, n3) => {
          const s = t2.Au.get(e5);
          if (!s)
            return;
          t2.Au.set(e5, s.withResumeToken(Ve.EMPTY_BYTE_STRING, s.snapshotVersion)), Xu(t2, e5);
          const i = new cr(s.target, e5, n3, s.sequenceNumber);
          Yu(t2, i);
        }), t2.remoteSyncer.applyRemoteEvent(n2);
      }(t, n);
    } catch (e3) {
      N("RemoteStore", "Failed to raise snapshot:", e3), await oc(t, e3);
    }
}
async function oc(t, e2, n) {
  if (!Dt(e2))
    throw e2;
...
function uc(t, e2) {
  return e2().catch((n) => oc(t, n, e2));
}
async function cc(t) {
  const e2 = L(t), n = Ic(e2);
  let s = e2.Eu.length > 0 ? e2.Eu[e2.Eu.length - 1].batchId : -1;
  for (; ac(e2); )
    try {
      const t2 = await au(e2.localStore, s);
      if (null === t2) {
        0 === e2.Eu.length && n.jo();
        break;
      }
      s = t2.batchId, hc(e2, t2);
    } catch (t2) {
      await oc(e2, t2);
    }
  lc(e2) && fc(e2);
...
async function _c(t, e2, n) {
  const s = t.Eu.shift(), i = ti.from(s, e2, n);
  await uc(t, () => t.remoteSyncer.applySuccessfulWrite(i)), await cc(t);
}
async function mc(t, e2) {
  e2 && Ic(t).ou && await async function(t2, e3) {
    if (n = e3.code, oi(n) && n !== q.ABORTED) {
      const n2 = t2.Eu.shift();
      Ic(t2).Qo(), await uc(t2, () => t2.remoteSyncer.rejectFailedWrite(n2.batchId, e3)), await cc(t2);
    }
    var n;
  }(t, e2), lc(t) && fc(t);
}
async function gc(t, e2) {
  const n = L(t);
  n.asyncQueue.verifyOperationInProgress(), N("RemoteStore", "RemoteStore received new credentials");
  const s = ec(n);
  n.vu.add(3), await Wu(n), s && n.bu.set("Unknown"), await n.remoteSyncer.handleCredentialChange(e2), n.vu.delete(3), await zu(n);
}
async function yc(t, e2) {
  const n = L(t);
  e2 ? (n.vu.delete(2), await zu(n)) : e2 || (n.vu.add(2), await Wu(n), n.bu.set("Unknown"));
}
function pc(t) {
  return t.Su || (t.Su = function(t2, e2, n) {
    const s = L(t2);
    return s.fu(), new qu(e2, s.connection, s.authCredentials, s.appCheckCredentials, s.serializer, n);
  }(t.datastore, t.asyncQueue, {
    uo: sc.bind(null, t),
    ao: ic.bind(null, t),
    nu: rc.bind(null, t)
  }), t.Ru.push(async (e2) => {
    e2 ? (t.Su.Qo(), tc(t) ? Zu(t) : t.bu.set("Unknown")) : (await t.Su.stop(), nc(t));
  })), t.Su;
}
function Ic(t) {
  return t.Du || (t.Du = function(t2, e2, n) {
    const s = L(t2);
    return s.fu(), new Uu(e2, s.connection, s.authCredentials, s.appCheckCredentials, s.serializer, n);
  }(t.datastore, t.asyncQueue, {
    uo: dc.bind(null, t),
    ao: mc.bind(null, t),
    au: wc.bind(null, t),
    ...
    e2 ? (t.Du.Qo(), await cc(t)) : (await t.Du.stop(), t.Eu.length > 0 && (N("RemoteStore", `Stopping write stream with ${t.Eu.length} pending writes`), t.Eu = []));
  })), t.Du;
}
/**
 * @license
...
class Tc {
  constructor(t, e2, n, s, i) {
    this.asyncQueue = t, this.timerId = e2, this.targetTimeMs = n, this.op = s, this.removalCallback = i, this.deferred = new K(), this.then = this.deferred.promise.then.bind(this.deferred.promise), this.deferred.promise.catch((t2) => {
    });
  }
  static createAndSchedule(t, e2, n, s, i) {
    const r2 = Date.now() + n, o = new Tc(t, e2, r2, s, i);
    return o.start(n), o;
  }
  start(t) {
...
function Ec(t, e2) {
  if (k("AsyncQueue", `${e2}: ${t}`), Dt(t))
    return new U(q.UNAVAILABLE, `${e2}: ${t}`);
  throw t;
}
/**
 * @license
...
class Ac {
  constructor(t) {
    this.comparator = t ? (e2, n) => t(e2, n) || ht.comparator(e2.key, n.key) : (t2, e2) => ht.comparator(t2.key, e2.key), this.keyedMap = hs(), this.sortedSet = new pe(this.comparator);
  }
  static emptySet(t) {
  ...
  forEach(t) {
    this.sortedSet.inorderTraversal((e2, n) => (t(e2), false));
  }
  add(t) {
    const e2 = this.delete(t.key);
    return e2.copy(e2.keyedMap.insert(t.key, t), e2.sortedSet.insert(t, null));
  }
  delete(t) {
    const e2 = this.get(t);
    return e2 ? this.copy(this.keyedMap.remove(t), this.sortedSet.remove(e2)) : this;
  }
  isEqual(t) {
    if (!(t instanceof Ac))
      return false;
    if (this.size !== t.size)
      return false;
    const e2 = this.sortedSet.getIterator(), n = t.sortedSet.getIterator();
    for (; e2.hasNext(); ) {
      const t2 = e2.getNext().key, s = n.getNext().key;
      if (!t2.isEqual(s))
        return false;
  ...
  copy(t, e2) {
    const n = new Ac();
    return n.comparator = this.comparator, n.keyedMap = t, n.sortedSet = e2, n;
  }
}
/**
 * @license
...
class vc {
  ...
  track(t) {
    const e2 = t.doc.key, n = this.Cu.get(e2);
    n ? 0 !== t.type && 3 === n.type ? this.Cu = this.Cu.insert(e2, t) : 3 === t.type && 1 !== n.type ? this.Cu = this.Cu.insert(e2, {
      type: n.type,
      doc: t.doc
    }) : 2 === t.type && 2 === n.type ? this.Cu = this.Cu.insert(e2, {
      type: 2,
      doc: t.doc
    }) : 2 === t.type && 0 === n.type ? this.Cu = this.Cu.insert(e2, {
      type: 0,
      doc: t.doc
    }) : 1 === t.type && 0 === n.type ? this.Cu = this.Cu.remove(e2) : 1 === t.type && 2 === n.type ? this.Cu = this.Cu.insert(e2, {
      type: 1,
      doc: n.doc
    }) : 0 === t.type && 1 === n.type ? this.Cu = this.Cu.insert(e2, {
      type: 2,
      doc: t.doc
    }) : O() : this.Cu = this.Cu.insert(e2, t);
  }
  xu() {
    const t = [];
    return this.Cu.inorderTraversal((e2, n) => {
      t.push(n);
    }), t;
  }
}
class Rc {
  constructor(t, e2, n, s, i, r2, o, u, c) {
    this.query = t, this.docs = e2, this.oldDocs = n, this.docChanges = s, this.mutatedKeys = i, this.fromCache = r2, this.syncStateChanged = o, this.excludesMetadataChanges = u, this.hasCachedResults = c;
  }
  static fromInitialDocuments(t, e2, n, s, i) {
    const r2 = [];
    return e2.forEach((t2) => {
      r2.push({
        type: 0,
  ...
  isEqual(t) {
    if (!(this.fromCache === t.fromCache && this.hasCachedResults === t.hasCachedResults && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && Zn(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs)))
      return false;
    const e2 = this.docChanges, n = t.docChanges;
    if (e2.length !== n.length)
      return false;
    for (let t2 = 0; t2 < e2.length; t2++)
      if (e2[t2].type !== n[t2].type || !e2[t2].doc.isEqual(n[t2].doc))
        return false;
    return true;
  }
}
...
async function Vc(t, e2) {
  const n = L(t), s = e2.query;
  let i = false, r2 = n.queries.get(s);
  if (r2 || (i = true, r2 = new Pc()), i)
    try {
      r2.Nu = await n.onListen(s);
    } catch (t2) {
      const n2 = Ec(t2, `Initialization of query '${es(e2.query)}' failed`);
      return void e2.onError(n2);
    }
  if (n.queries.set(s, r2), r2.listeners.push(e2), e2.Mu(n.onlineState), r2.Nu) {
    e2.$u(r2.Nu) && xc(n);
  }
}
async function Sc(t, e2) {
  const n = L(t), s = e2.query;
  let i = false;
  const r2 = n.queries.get(s);
  if (r2) {
    const t2 = r2.listeners.indexOf(e2);
...
function Dc(t, e2) {
  ...
  let s = false;
  for (const t2 of e2) {
    const e3 = t2.query, i = n.queries.get(e3);
    if (i) {
      for (const e4 of i.listeners)
        e4.$u(t2) && (s = true);
      i.Nu = t2;
    }
  }
...
function Cc(t, e2, n) {
  const s = L(t), i = s.queries.get(e2);
  if (i)
...
class Nc {
  constructor(t, e2, n) {
    this.query = t, this.Ou = e2, this.Fu = false, this.Bu = null, this.onlineState = "Unknown", this.options = n || {};
  }
  $u(t) {
    ...
    let e2 = false;
    return this.Fu ? this.Lu(t) && (this.Ou.next(t), e2 = true) : this.qu(t, this.onlineState) && (this.Uu(t), e2 = true), this.Bu = t, e2;
  }
  onError(t) {
    this.Ou.error(t);
  }
  Mu(t) {
    this.onlineState = t;
    let e2 = false;
    return this.Bu && !this.Fu && this.qu(this.Bu, t) && (this.Uu(this.Bu), e2 = true), e2;
  }
  qu(t, e2) {
    if (!t.fromCache)
      return true;
    const n = "Offline" !== e2;
    return (!this.options.Ku || !n) && (!t.docs.isEmpty() || t.hasCachedResults || "Offline" === e2);
  }
  Lu(t) {
    if (t.docChanges.length > 0)
      return true;
    const e2 = this.Bu && this.Bu.hasPendingWrites !== t.hasPendingWrites;
    return !(!t.syncStateChanged && !e2) && true === this.options.includeMetadataChanges;
  }
  Uu(t) {
...
class Lc {
  constructor(t, e2) {
    this.query = t, this.Yu = e2, this.Xu = null, this.hasCachedResults = false, this.current = false, this.Zu = gs(), this.mutatedKeys = gs(), this.tc = is(t), this.ec = new Ac(this.tc);
  }
  get nc() {
    return this.Yu;
  }
  sc(t, e2) {
    const n = e2 ? e2.ic : new vc(), s = e2 ? e2.ec : this.ec;
    let i = e2 ? e2.mutatedKeys : this.mutatedKeys, r2 = s, o = false;
    ...
    if (t.inorderTraversal((t2, e3) => {
      const a = s.get(t2), h = ns(this.query, e3) ? e3 : null, l2 = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || this.mutatedKeys.has(h.key) && h.hasCommittedMutations);
      let d = false;
      if (a && h) {
  ...
  rc(t, e2) {
    return t.hasLocalMutations && e2.hasCommittedMutations && !e2.hasLocalMutations;
  }
  applyChanges(t, e2, n) {
    const s = this.ec;
    this.ec = t.ec, this.mutatedKeys = t.mutatedKeys;
    const i = t.ic.xu();
    i.sort((t2, e3) => function(t3, e4) {
      const n2 = (t4) => {
        switch (t4) {
          case 0:
            return 1;
      ...
      return n2(t3) - n2(e4);
    }(t2.type, e3.type) || this.tc(t2.doc, e3.doc)), this.oc(n);
    const r2 = e2 ? this.uc() : [], o = 0 === this.Zu.size && this.current ? 1 : 0, u = o !== this.Xu;
  ...
  uc() {
    ...
    const e2 = [];
    return t.forEach((t2) => {
      this.Zu.has(t2) || e2.push(new Bc(t2));
    }), this.Zu.forEach((n) => {
      t.has(n) || e2.push(new Fc(n));
    }), e2;
  }
  hc(t) {
    this.Yu = t.ir, this.Zu = gs();
    const e2 = this.sc(t.documents);
...
class qc {
  constructor(t, e2, n) {
    this.query = t, this.targetId = e2, this.view = n;
  }
}
class Uc {
  constructor(t) {
...
async function Gc(t, e2) {
  const n = pa(t);
  let s, i;
  const r2 = n.wc.get(e2);
  if (r2)
    s = r2.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r2.view.lc();
  else {
    const t2 = await hu(n.localStore, Jn(e2)), r3 = n.sharedClientState.addLocalQueryTarget(t2.targetId);
    s = t2.targetId, i = await Qc(n, e2, s, "current" === r3, t2.resumeToken), n.isPrimaryClient && Hu(n.remoteStore, t2);
  }
  return i;
}
async function Qc(t, e2, n, s, i) {
  t.Rc = (e3, n2, s2) => async function(t2, e4, n3, s3) {
    let i2 = e4.view.sc(n3);
    i2.zi && (i2 = await fu(
      t2.localStore,
      e4.query,
      false
    ).then(({ documents: t3 }) => e4.view.sc(t3, i2)));
    const r3 = s3 && s3.targetChanges.get(e4.targetId), o2 = e4.view.applyChanges(
      i2,
      t2.isPrimaryClient,
      r3
    );
    return ia(t2, e4.targetId, o2.cc), o2.snapshot;
  }(t, e3, n2, s2);
  const r2 = await fu(
    t.localStore,
    e2,
    true
  ), o = new Lc(e2, r2.ir), u = o.sc(r2.documents), c = gi.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t.onlineState, i), a = o.applyChanges(
    u,
    t.isPrimaryClient,
    c
  );
  ia(t, n, a.cc);
  const h = new qc(e2, n, o);
  return t.wc.set(e2, h), t._c.has(n) ? t._c.get(n).push(e2) : t._c.set(n, [e2]), a.snapshot;
}
async function jc(t, e2) {
  const n = L(t), s = n.wc.get(e2), i = n._c.get(s.targetId);
  if (i.length > 1)
    return n._c.set(s.targetId, i.filter((t2) => !Zn(t2, e2))), void n.wc.delete(e2);
...
async function zc(t, e2, n) {
  const s = Ia(t);
  try {
    const t2 = await function(t3, e3) {
      const n2 = L(t3), s2 = it.now(), i = e3.reduce((t4, e4) => t4.add(e4.key), gs());
      let r2, o;
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t4) => {
        let u = cs(), c = gs();
        return n2.Zi.getEntries(t4, i).next((t5) => {
          u = t5, u.forEach((t6, e4) => {
            e4.isValidDocument() || (c = c.add(t6));
          });
        }).next(() => n2.localDocuments.getOverlayedDocuments(t4, u)).next((i2) => {
          r2 = i2;
          const o2 = [];
          for (const t5 of e3) {
            const e4 = Gs(t5, r2.get(t5.key).overlayedDocument);
            null != e4 && o2.push(new zs(t5.key, e4, cn(e4.value.mapValue), Fs.exists(true)));
          }
          return n2.mutationQueue.addMutationBatch(t4, s2, o2, e3);
        }).next((e4) => {
          o = e4;
          const s3 = e4.applyToLocalDocumentSet(r2, c);
          return n2.documentOverlayCache.saveOverlays(t4, e4.batchId, s3);
        });
      }).then(() => ({
        batchId: o.batchId,
        changes: ls(r2)
    ...
    s.sharedClientState.addPendingMutation(t2.batchId), function(t3, e3, n2) {
      let s2 = t3.Tc[t3.currentUser.toKey()];
      s2 || (s2 = new pe(et));
      s2 = s2.insert(e3, n2), t3.Tc[t3.currentUser.toKey()] = s2;
    }(s, t2.batchId, n), await ua(s, t2.changes), await cc(s.remoteStore);
  } catch (t2) {
    const e3 = Ec(t2, "Failed to persist write");
    n.reject(e3);
  }
}
async function Wc(t, e2) {
  const n = L(t);
  try {
    const t2 = await uu(n.localStore, e2);
    e2.targetChanges.forEach((t3, e3) => {
      const s = n.yc.get(e3);
...
function Hc(t, e2, n) {
  ...
  if (s.isPrimaryClient && 0 === n || !s.isPrimaryClient && 1 === n) {
    ...
    }(s.eventManager, e2), t2.length && s.dc.nu(t2), s.onlineState = e2, s.isPrimaryClient && s.sharedClientState.setOnlineState(e2);
  }
}
async function Jc(t, e2, n) {
  const s = L(t);
  s.sharedClientState.updateQueryState(e2, "rejected", n);
  const i = s.yc.get(e2), r2 = i && i.key;
  if (r2) {
    ...
    await Wc(s, i2), s.gc = s.gc.remove(r2), s.yc.delete(e2), oa(s);
  } else
    await lu(
      s.localStore,
      e2,
      false
    ).then(() => na(s, e2, n)).catch(vt);
}
async function Yc(t, e2) {
  const n = L(t), s = e2.batch.batchId;
  try {
    const t2 = await ru(n.localStore, e2);
    ea(n, s, null), ta(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await ua(n, t2);
  } catch (t2) {
    await vt(t2);
  }
}
async function Xc(t, e2, n) {
  const s = L(t);
  try {
    const t2 = await function(t3, e3) {
      const n2 = L(t3);
      return n2.persistence.runTransaction("Reject batch", "readwrite-primary", (t4) => {
        let s2;
        return n2.mutationQueue.lookupMutationBatch(t4, e3).next((e4) => (F(null !== e4), s2 = e4.keys(), n2.mutationQueue.removeMutationBatch(t4, e4))).next(() => n2.mutationQueue.performConsistencyCheck(t4)).next(() => n2.documentOverlayCache.removeOverlaysForBatchId(t4, s2, e3)).next(() => n2.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t4, s2)).next(() => n2.localDocuments.getDocuments(t4, s2));
      });
    }(s.localStore, e2);
    ea(s, e2, n), ta(s, e2), s.sharedClientState.updateMutationState(e2, "rejected", n), await ua(s, t2);
  } catch (n2) {
    await vt(n2);
  }
}
function ta(t, e2) {
  (t.Ec.get(e2) || []).forEach((t2) => {
    t2.resolve();
  }), t.Ec.delete(e2);
}
function ea(t, e2, n) {
  ...
  if (i) {
    const t2 = i.get(e2);
    t2 && (n ? t2.reject(n) : t2.resolve(), i = i.remove(e2)), s.Tc[s.currentUser.toKey()] = i;
  }
}
function na(t, e2, n = null) {
  t.sharedClientState.removeLocalQueryTarget(e2);
  for (const s of t._c.get(e2))
    t.wc.delete(s), n && t.dc.Pc(s, n);
  if (t._c.delete(e2), t.isPrimaryClient) {
    t.Ic.Is(e2).forEach((e3) => {
      t.Ic.containsKey(e3) || sa(t, e3);
    });
  }
}
function sa(t, e2) {
  t.mc.delete(e2.path.canonicalString());
  const n = t.gc.get(e2);
  null !== n && (Ju(t.remoteStore, n), t.gc = t.gc.remove(e2), t.yc.delete(n), oa(t));
}
function ia(t, e2, n) {
  for (const s of n)
    if (s instanceof Fc)
      t.Ic.addReference(s.key, e2), ra(t, s);
    else if (s instanceof Bc) {
      N("SyncEngine", "Document no longer in limbo: " + s.key), t.Ic.removeReference(s.key, e2);
      t.Ic.containsKey(s.key) || sa(t, s.key);
    } else
      O();
}
function ra(t, e2) {
  const n = e2.key, s = n.path.canonicalString();
  ...
  s.wc.isEmpty() || (s.wc.forEach((t2, u) => {
    o.push(s.Rc(u, e2, n).then((t3) => {
      if ((t3 || n) && s.isPrimaryClient && s.sharedClientState.updateQueryState(u.targetId, (null == t3 ? void 0 : t3.fromCache) ? "not-current" : "current"), t3) {
        i.push(t3);
        const e3 = tu.Li(u.targetId, t3);
        r2.push(e3);
      }
    }));
  }), await Promise.all(o), s.dc.nu(i), await async function(t2, e3) {
    const n2 = L(t2);
    try {
      await n2.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t3) => Rt.forEach(e3, (e4) => Rt.forEach(e4.Fi, (s2) => n2.persistence.referenceDelegate.addReference(t3, e4.targetId, s2)).next(() => Rt.forEach(e4.Bi, (s2) => n2.persistence.referenceDelegate.removeReference(t3, e4.targetId, s2)))));
    } catch (t3) {
      if (!Dt(t3))
        throw t3;
    ...
    for (const t3 of e3) {
      const e4 = t3.targetId;
      if (!t3.fromCache) {
        const t4 = n2.Ji.get(e4), s2 = t4.snapshotVersion, i2 = t4.withLastLimboFreeSnapshotVersion(s2);
        n2.Ji = n2.Ji.insert(e4, i2);
      }
    }
  }(s.localStore, r2));
}
async function ca(t, e2) {
  const n = L(t);
  if (!n.currentUser.isEqual(e2)) {
    N("SyncEngine", "User change. New user:", e2.toKey());
    const t2 = await iu(n.localStore, e2);
    n.currentUser = e2, function(t3, e3) {
      t3.Ec.forEach((t4) => {
        t4.forEach((t5) => {
          t5.reject(new U(q.CANCELLED, e3));
        });
      }), t3.Ec.clear();
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e2, t2.removedBatchIds, t2.addedBatchIds), await ua(n, t2.er);
  }
}
function aa(t, e2) {
  const n = L(t), s = n.yc.get(e2);
  if (s && s.fc)
    return gs().add(s.key);
  {
    let t2 = gs();
    const s2 = n._c.get(e2);
    if (!s2)
      return t2;
    for (const e3 of s2) {
      const s3 = n.wc.get(e3);
...
function pa(t) {
  const e2 = L(t);
  return e2.remoteStore.remoteSyncer.applyRemoteEvent = Wc.bind(null, e2), e2.remoteStore.remoteSyncer.getRemoteKeysForTarget = aa.bind(null, e2), e2.remoteStore.remoteSyncer.rejectListen = Jc.bind(null, e2), e2.dc.nu = Dc.bind(null, e2.eventManager), e2.dc.Pc = Cc.bind(null, e2.eventManager), e2;
}
function Ia(t) {
  const e2 = L(t);
  return e2.remoteStore.remoteSyncer.applySuccessfulWrite = Yc.bind(null, e2), e2.remoteStore.remoteSyncer.rejectFailedWrite = Xc.bind(null, e2), e2;
}
class Ea {
  constructor() {
  ...
  createGarbageCollectionScheduler(t, e2) {
    return null;
  }
  createIndexBackfillerScheduler(t, e2) {
    return null;
  }
  createLocalStore(t) {
...
class Pa {
  async initialize(t, e2) {
    this.localStore || (this.localStore = t.localStore, this.sharedClientState = t.sharedClientState, this.datastore = this.createDatastore(e2), this.remoteStore = this.createRemoteStore(e2), this.eventManager = this.createEventManager(e2), this.syncEngine = this.createSyncEngine(
      e2,
      !t.synchronizeTabs
  ...
  createDatastore(t) {
    const e2 = Fu(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Mu(s));
    var s;
    return function(t2, e3, n2, s2) {
      return new Ku(t2, e3, n2, s2);
    }(t.authCredentials, t.appCheckCredentials, n, e2);
  }
  createRemoteStore(t) {
    return e2 = this.localStore, n = this.datastore, s = t.asyncQueue, i = (t2) => Hc(this.syncEngine, t2, 0), r2 = Su.D() ? new Su() : new Vu(), new ju(e2, n, s, i, r2);
    var e2, n, s, i, r2;
  }
  createSyncEngine(t, e2) {
    return function(t2, e3, n, s, i, r2, o) {
      const u = new Kc(t2, e3, n, s, i, r2);
      return o && (u.vc = true), u;
    }(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, t.initialUser, t.maxConcurrentLimboResolutions, e2);
  }
  terminate() {
    return async function(t) {
      const e2 = L(t);
      N("RemoteStore", "RemoteStore shutting down."), e2.vu.add(5), await Wu(e2), e2.Pu.shutdown(), e2.bu.set("Unknown");
    }(this.remoteStore);
  }
}
/**
...
class xa {
  constructor(t, e2, n, s) {
    this.authCredentials = t, this.appCheckCredentials = e2, this.asyncQueue = n, this.databaseInfo = s, this.user = V.UNAUTHENTICATED, this.clientId = tt.A(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this.authCredentials.start(n, async (t2) => {
  ...
  terminate() {
    ...
    return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
      try {
        ...
        const n = Ec(e2, "Failed to shutdown persistence");
        t.reject(n);
      }
    }), t.promise;
  }
}
async function Na(t, e2) {
  t.asyncQueue.verifyOperationInProgress(), N("FirestoreClient", "Initializing OfflineComponentProvider");
  const n = await t.getConfiguration();
  await e2.initialize(n);
  let s = n.initialUser;
  t.setCredentialChangeListener(async (t2) => {
    s.isEqual(t2) || (await iu(e2.localStore, t2), s = t2);
  }), e2.persistence.setDatabaseDeletedListener(() => t.terminate()), t._offlineComponents = e2;
}
async function ka(t, e2) {
  t.asyncQueue.verifyOperationInProgress();
  const n = await $a(t);
  N("FirestoreClient", "Initializing OnlineComponentProvider");
  const s = await t.getConfiguration();
  await e2.initialize(n, s), t.setCredentialChangeListener((t2) => gc(e2.remoteStore, t2)), t.setAppCheckTokenChangeListener((t2, n2) => gc(e2.remoteStore, n2)), t._onlineComponents = e2;
}
function Ma(t) {
...
async function Ka(t) {
  const e2 = await Oa(t), n = e2.eventManager;
  return n.onListen = Gc.bind(null, e2.syncEngine), n.onUnlisten = jc.bind(null, e2.syncEngine), n;
}
function za(t, e2, n = {}) {
  const s = new K();
  return t.asyncQueue.enqueueAndForget(async () => function(t2, e3, n2, s2, i) {
    const r2 = new Va({
      next: (r3) => {
        e3.enqueueAndForget(() => Sc(t2, o));
    ...
    return Vc(t2, o);
  }(await Ka(t), t.asyncQueue, e2, n, s)), s.promise;
}
function Ha(t, e2, n = {}) {
  const s = new K();
  return t.asyncQueue.enqueueAndForget(async () => function(t2, e3, n2, s2, i) {
    const r2 = new Va({
      next: (n3) => {
        e3.enqueueAndForget(() => Sc(t2, o)), n3.fromCache && "server" === s2.source ? i.reject(new U(q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t3) => i.reject(t3)
    }), o = new Nc(n2, r2, {
      includeMetadataChanges: true,
...
function th(t) {
  const e2 = {};
  return void 0 !== t.timeoutSeconds && (e2.timeoutSeconds = t.timeoutSeconds), e2;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
function nh(t, e2, n) {
  if (!n)
    throw new U(q.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e2}.`);
}
function sh(t, e2, n, s) {
  if (true === e2 && true === s)
...
function uh(t, e2) {
  if ("_delegate" in t && (t = t._delegate), !(t instanceof e2)) {
    if (e2.name === t.constructor.name)
    ...
    {
      const n = oh(t);
      throw new U(q.INVALID_ARGUMENT, `Expected type '${e2.name}', but it was: ${n}`);
    }
  }
  return t;
}
...
class ah {
  constructor(t) {
    ...
    if (void 0 === t.host) {
      ...
      this.host = t.host, this.ssl = null === (e2 = t.ssl) || void 0 === e2 || e2;
  ...
  isEqual(t) {
    return this.host === t.host && this.ssl === t.ssl && this.credentials === t.credentials && this.cacheSizeBytes === t.cacheSizeBytes && this.experimentalForceLongPolling === t.experimentalForceLongPolling && this.experimentalAutoDetectLongPolling === t.experimentalAutoDetectLongPolling && (e2 = this.experimentalLongPollingOptions, n = t.experimentalLongPollingOptions, e2.timeoutSeconds === n.timeoutSeconds) && this.ignoreUndefinedProperties === t.ignoreUndefinedProperties && this.useFetchStreams === t.useFetchStreams;
    var e2, n;
  }
}
class hh {
  constructor(t, e2, n, s) {
    this._authCredentials = t, this._appCheckCredentials = e2, this._databaseId = n, this._app = s, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new ah({}), this._settingsFrozen = false;
  }
  get app() {
    if (!this._app)
  ...
  _terminate() {
    return function(t) {
      const e2 = eh.get(t);
      e2 && (N("ComponentProvider", "Removing Datastore"), eh.delete(t), e2.terminate());
    }(this), Promise.resolve();
  }
}
function lh(t, e2, n, s = {}) {
  var i;
  const r2 = (t = uh(t, hh))._getSettings();
  if ("firestore.googleapis.com" !== r2.host && r2.host !== e2 && M("Host has been set in both settings() and useEmulator(), emulator host will be used"), t._setSettings(Object.assign(Object.assign({}, r2), {
    host: `${e2}:${n}`,
    ssl: false
  })), s.mockUserToken) {
    let e3, n2;
    if ("string" == typeof s.mockUserToken)
      e3 = s.mockUserToken, n2 = V.MOCK_USER;
    else {
      e3 = createMockUserToken(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
    ...
    t._authCredentials = new j(new G(e3, n2));
  }
}
/**
 * @license
...
class fh {
  constructor(t, e2, n) {
    this.converter = e2, this._key = n, this.type = "document", this.firestore = t;
  }
  get _path() {
...
class dh {
  constructor(t, e2, n) {
    this.converter = e2, this._query = n, this.type = "query", this.firestore = t;
  }
  withConverter(t) {
...
class wh extends dh {
  constructor(t, e2, n) {
    super(t, e2, Gn(n)), this._path = n, this.type = "collection";
  }
  get id() {
...
function _h(t, e2, ...n) {
  if (t = getModularInstance(t), nh("collection", "path", e2), t instanceof hh) {
    const s = ut.fromString(e2, ...n);
  ...
  }
  {
    ...
    const s = t._path.child(ut.fromString(e2, ...n));
    return rh(s), new wh(
      t.firestore,
      null,
      s
...
function gh(t, e2, ...n) {
  if (t = getModularInstance(t), 1 === arguments.length && (e2 = tt.A()), nh("doc", "path", e2), t instanceof hh) {
    const s = ut.fromString(e2, ...n);
    return ih(s), new fh(
      t,
      null,
...
class Ih {
  ...
  enterRestrictedMode(t) {
    if (!this.jc) {
      ...
      const e2 = Ou();
      e2 && "function" == typeof e2.removeEventListener && e2.removeEventListener("visibilitychange", this.Xc);
    }
  }
  enqueue(t) {
    if (this.Zc(), this.jc)
    ...
    const e2 = new K();
    return this.ta(() => this.jc && this.Jc ? Promise.resolve() : (t().then(e2.resolve, e2.reject), e2.promise)).then(() => e2.promise);
  }
  enqueueRetryable(t) {
  ...
  ta(t) {
    const e2 = this.Gc.then(() => (this.Hc = true, t().catch((t2) => {
      this.Wc = t2, this.Hc = false;
      const e3 = function(t3) {
        let e4 = t3.message || "";
        t3.stack && (e4 = t3.stack.includes(t3.message) ? t3.stack : t3.message + "\n" + t3.stack);
        return e4;
      }(t2);
      throw k("INTERNAL UNHANDLED ERROR: ", e3), t2;
    }).then((t2) => (this.Hc = false, t2))));
    return this.Gc = e2, e2;
  }
  enqueueAfterDelay(t, e2, n) {
    this.Zc(), this.Yc.indexOf(t) > -1 && (e2 = 0);
    const s = Tc.createAndSchedule(this, t, e2, n, (t2) => this.na(t2));
  ...
  ra(t) {
    return this.sa().then(() => {
      this.zc.sort((t2, e2) => t2.targetTimeMs - e2.targetTimeMs);
      for (const e2 of this.zc)
        if (e2.skipDelay(), "all" !== t && e2.timerId === t)
          break;
      return this.sa();
    });
  }
...
class vh extends hh {
  constructor(t, e2, n, s) {
    super(t, e2, n, s), this.type = "firestore", this._queue = new Ih(), this._persistenceKey = (null == s ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function Ph(e2, n) {
  const s = "object" == typeof e2 ? e2 : getApp(), i = "string" == typeof e2 ? e2 : n || "(default)", r2 = _getProvider(s, "firestore").getImmediate({
    identifier: i
  });
  if (!r2._initialized) {
...
function Vh(t) {
  var e2, n, s;
  const i = t._freezeSettings(), r2 = function(t2, e3, n2, s2) {
    return new $e(t2, e3, n2, s2.host, s2.ssl, s2.experimentalForceLongPolling, s2.experimentalAutoDetectLongPolling, th(s2.experimentalLongPollingOptions), s2.useFetchStreams);
  }(t._databaseId, (null === (e2 = t._app) || void 0 === e2 ? void 0 : e2.options.appId) || "", t._persistenceKey, i);
...
class jh {
  constructor(t, e2) {
    ...
    if (!isFinite(e2) || e2 < -180 || e2 > 180)
      throw new U(q.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e2);
    this._lat = t, this._long = e2;
  }
  get latitude() {
    return this._lat;
  }
...
class Wh {
  constructor(t, e2, n) {
    this.data = t, this.fieldMask = e2, this.fieldTransforms = n;
  }
  toMutation(t, e2) {
    return null !== this.fieldMask ? new zs(t, this.data, this.fieldMask, e2, this.fieldTransforms) : new js(t, this.data, e2, this.fieldTransforms);
  }
}
class Hh {
  constructor(t, e2, n) {
  ...
  toMutation(t, e2) {
    return new zs(t, this.data, this.fieldMask, e2, this.fieldTransforms);
  }
}
function Jh(t) {
  switch (t) {
...
class Yh {
  constructor(t, e2, n, s, i, r2) {
    this.settings = t, this.databaseId = e2, this.serializer = n, this.ignoreUndefinedProperties = s, void 0 === i && this.ua(), this.fieldTransforms = i || [], this.fieldMask = r2 || [];
  }
  get path() {
  ...
  ha(t) {
    var e2;
    const n = null === (e2 = this.path) || void 0 === e2 ? void 0 : e2.child(t), s = this.aa({
      path: n,
      la: false
    });
    return s.fa(t), s;
  ...
  contains(t) {
    return void 0 !== this.fieldMask.find((e2) => t.isPrefixOf(e2)) || void 0 !== this.fieldTransforms.find((e2) => t.isPrefixOf(e2.field));
  }
  ua() {
    if (this.path)
...
class Xh {
  constructor(t, e2, n) {
    this.databaseId = t, this.ignoreUndefinedProperties = e2, this.serializer = n || Fu(t);
  }
  ya(t, e2, n, s = false) {
    return new Yh({
      ca: t,
...
function Zh(t) {
  const e2 = t._freezeSettings(), n = Fu(t._databaseId);
  return new Xh(t._databaseId, !!e2.ignoreUndefinedProperties, n);
}
function tl(t, e2, n, s, i, r2 = {}) {
  const o = t.ya(r2.merge || r2.mergeFields ? 2 : 0, e2, n, i);
...
function nl(t, e2, n) {
  return new Yh({
    ...
    la: n
  }, e2.databaseId, e2.serializer, e2.ignoreUndefinedProperties);
}
class sl extends Qh {
  _toFieldTransform(t) {
...
class il extends Qh {
  ...
  _toFieldTransform(t) {
    const e2 = nl(
      ...
      t,
      true
    ), n = this.pa.map((t2) => hl(t2, e2)), s = new Vs(n);
...
class rl extends Qh {
  ...
  _toFieldTransform(t) {
    const e2 = nl(
      ...
      t,
      true
    ), n = this.pa.map((t2) => hl(t2, e2)), s = new Ds(n);
    return new Ms(t.path, s);
  }
  isEqual(t) {
    return this === t;
...
function cl(t, e2, n, s, i, r2) {
  const o = t.ya(1, e2, n), u = [wl(e2, s, n)], c = [i];
  if (r2.length % 2 != 0)
    throw new U(q.INVALID_ARGUMENT, `Function ${e2}() needs to be called with an even number of arguments that alternate between field names and values.`);
  for (let t2 = 0; t2 < r2.length; t2 += 2)
    u.push(wl(e2, r2[t2])), c.push(r2[t2 + 1]);
  const a = [], h = un.empty();
...
function hl(t, e2) {
  if (fl(
    ...
    return dl("Unsupported field value:", e2, t), ll(t, e2);
  if (t instanceof Qh)
    return function(t2, e3) {
      if (!Jh(e3.ca))
        throw e3._a(`${t2._methodName}() can only be used with update() and set()`);
      if (!e3.path)
        throw e3._a(`${t2._methodName}() is not currently supported inside arrays`);
      const n = t2._toFieldTransform(e3);
      n && e3.fieldTransforms.push(n);
    }(t, e2), null;
  if (void 0 === t && e2.ignoreUndefinedProperties)
    return null;
  if (e2.path && e2.fieldMask.push(e2.path), t instanceof Array) {
    if (e2.settings.la && 4 !== e2.ca)
      throw e2._a("Nested arrays are not supported");
    return function(t2, e3) {
      const n = [];
      let s = 0;
      for (const i of t2) {
  ...
  return function(t2, e3) {
    ...
    if (t2 instanceof Date) {
      ...
      return {
        timestampValue: Di(e3.serializer, n)
      };
    }
    if (t2 instanceof it) {
    ...
    if (t2 instanceof Uh)
      return {
        bytesValue: Ci(e3.serializer, t2._byteString)
      };
    if (t2 instanceof fh) {
      const n = e3.databaseId, s = t2.firestore._databaseId;
      if (!s.isEqual(n))
        throw e3._a(`Document reference is for database ${s.projectId}/${s.database} but should be for database ${n.projectId}/${n.database}`);
      return {
        referenceValue: ki(t2.firestore._databaseId || e3.databaseId, t2._key.path)
      };
    }
    throw e3._a(`Unsupported field value: ${oh(t2)}`);
  }(t, e2);
}
function ll(t, e2) {
  const n = {};
  return ye(t) ? e2.path && e2.path.length > 0 && e2.fieldMask.push(e2.path) : ge(t, (t2, s) => {
    const i = hl(s, e2.ha(t2));
    null != i && (n[t2] = i);
  }), {
    mapValue: {
      fields: n
...
function dl(t, e2, n) {
  if (!fl(n) || !function(t2) {
    ...
    const s = oh(n);
    throw "an object" === s ? e2._a(t + " a custom object") : e2._a(t + " " + s);
  }
}
function wl(t, e2, n) {
  if ((e2 = getModularInstance(e2)) instanceof Kh)
...
function ml(t, e2, n) {
  ...
  try {
    return new Kh(...e2.split("."))._internalPath;
  } catch (s) {
    throw gl(
...
class pl {
  constructor(t, e2, n, s, i) {
    this._firestore = t, this._userDataWriter = e2, this._key = n, this._document = s, this._converter = i;
  }
  get id() {
    return this._key.path.lastSegment();
  }
  ...
  get(t) {
    if (this._document) {
      const e2 = this._document.data.field(Tl("DocumentSnapshot.get", t));
      if (null !== e2)
...
function Tl(t, e2) {
  return "string" == typeof e2 ? ml(t, e2) : e2 instanceof Kh ? e2._internalPath : e2._delegate._internalPath;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class Wl {
  convertValue(t, e2 = "none") {
    switch (Le(t)) {
      ...
      case 4:
        return this.convertServerTimestamp(t, e2);
      case 5:
      ...
      case 9:
        return this.convertArray(t.arrayValue, e2);
      case 10:
        return this.convertObject(t.mapValue, e2);
      default:
        throw O();
    }
  }
  convertObject(t, e2) {
    return this.convertObjectMap(t.fields, e2);
  }
  convertObjectMap(t, e2 = "none") {
    const n = {};
    return ge(t, (t2, s) => {
      n[t2] = this.convertValue(s, e2);
    }), n;
  }
  convertGeoPoint(t) {
  ...
  convertArray(t, e2) {
    return (t.values || []).map((t2) => this.convertValue(t2, e2));
  }
  convertServerTimestamp(t, e2) {
    switch (e2) {
      case "previous":
        const n = ke(t);
        return null == n ? null : this.convertValue(n, e2);
      case "estimate":
  ...
  convertDocumentKey(t, e2) {
    const n = ut.fromString(t);
    F(ur(n));
    const s = new Oe(n.get(1), n.get(3)), i = new ht(n.popFirst(5));
    return s.isEqual(e2) || k(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e2.projectId}/${e2.database}) instead.`), i;
  }
}
/**
 * @license
...
function Hl(t, e2, n) {
  let s;
  return s = t ? n && (n.merge || n.mergeFields) ? t.toFirestore(e2, n) : t.toFirestore(e2) : e2, s;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class nf {
  constructor(t, e2) {
    this.hasPendingWrites = t, this.fromCache = e2;
  }
  isEqual(t) {
...
class sf extends pl {
  constructor(t, e2, n, s, i, r2) {
    super(t, e2, n, s, r2), this._firestore = t, this._firestoreImpl = t, this.metadata = i;
  }
  exists() {
    return super.exists();
  }
  data(t = {}) {
    if (this._document) {
      if (this._converter) {
        ...
        return this._converter.fromFirestore(e2, t);
      }
  ...
  get(t, e2 = {}) {
    if (this._document) {
      ...
      if (null !== n)
        return this._userDataWriter.convertValue(n, e2.serverTimestamps);
    }
  }
}
class rf extends sf {
...
class of {
  constructor(t, e2, n, s) {
    this._firestore = t, this._userDataWriter = e2, this._snapshot = s, this.metadata = new nf(s.hasPendingWrites, s.fromCache), this.query = n;
  }
  get docs() {
    const t = [];
    return this.forEach((e2) => t.push(e2)), t;
  }
  get size() {
  ...
  forEach(t, e2) {
    this._snapshot.docs.forEach((n) => {
      t.call(e2, new rf(this._firestore, this._userDataWriter, n.key, n, new nf(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
    });
  }
  docChanges(t = {}) {
    const e2 = !!t.includeMetadataChanges;
    ...
    return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e2 || (this._cachedChanges = function(t2, e3) {
      ...
      }
      {
        ...
        return t2._snapshot.docChanges.filter((t3) => e3 || 3 !== t3.type).map((e4) => {
          const s = new rf(t2._firestore, t2._userDataWriter, e4.doc.key, e4.doc, new nf(t2._snapshot.mutatedKeys.has(e4.doc.key), t2._snapshot.fromCache), t2.query.converter);
          let i = -1, r2 = -1;
          return 0 !== e4.type && (i = n.indexOf(e4.doc.key), n = n.delete(e4.doc.key)), 1 !== e4.type && (n = n.add(e4.doc), r2 = n.indexOf(e4.doc.key)), {
            type: uf(e4.type),
            doc: s,
            oldIndex: i,
            newIndex: r2
...
function af(t) {
  t = uh(t, fh);
  const e2 = uh(t.firestore, vh);
  return za(bh(e2), t._key).then((n) => Af(e2, t, n));
}
class hf extends Wl {
  constructor(t) {
  ...
  convertReference(t) {
    const e2 = this.convertDocumentKey(t, this.firestore._databaseId);
    return new fh(this.firestore, null, e2);
  }
}
function df(t) {
  t = uh(t, dh);
  const e2 = uh(t.firestore, vh), n = bh(e2), s = new hf(e2);
  return El(t._query), Ha(n, t._query).then((n2) => new of(e2, s, t, n2));
}
function gf(t, e2, n, ...s) {
  t = uh(t, fh);
  const i = uh(t.firestore, vh), r2 = Zh(i);
  let o;
  o = "string" == typeof (e2 = getModularInstance(e2)) || e2 instanceof Kh ? cl(r2, "updateDoc", t._key, e2, n, s) : ul(r2, "updateDoc", t._key, e2);
...
function pf(t, e2) {
  const n = uh(t.firestore, vh), s = gh(t), i = Hl(t.converter, e2);
...
function If(t, ...e2) {
  ...
  "object" != typeof e2[o] || Th(e2[o]) || (r2 = e2[o], o++);
  const u = {
    includeMetadataChanges: r2.includeMetadataChanges
  };
  if (Th(e2[o])) {
    const t2 = e2[o];
    e2[o] = null === (n = t2.next) || void 0 === n ? void 0 : n.bind(t2), e2[o + 1] = null === (s = t2.error) || void 0 === s ? void 0 : s.bind(t2), e2[o + 2] = null === (i = t2.complete) || void 0 === i ? void 0 : i.bind(t2);
  }
  let c, a, h;
  if (t instanceof fh)
  ...
  return function(t2, e3, n2, s2) {
    const i2 = new Va(s2), r3 = new Nc(e3, i2, n2);
...
function Ef(t, e2) {
  return function(t2, e3) {
    const n = new K();
    return t2.asyncQueue.enqueueAndForget(async () => zc(await qa(t2), e3, n)), n.promise;
  }(bh(t), e2);
}
function Af(t, e2, n) {
  const s = n.docs.get(e2._key), i = new hf(t);
  return new sf(t, i, e2._key, s, new nf(n.hasPendingWrites, n.fromCache), e2.converter);
}
function Gf() {
...
!function(t, e2 = true) {
  !function(t2) {
    ...
    const i = t2.getProvider("app").getImmediate(), r2 = new vh(new z(t2.getProvider("auth-internal")), new Y(t2.getProvider("app-check-internal")), function(t3, e3) {
      ...
      return new Oe(t3.options.projectId, e3);
    }(i, n), i);
...
const db = Ph(app);
_h(db, "tasks");
const revision = (email, password, error1) => new Promise((resolve, reject) => {
  signInWithEmailAndPassword(auth, email, password).then((userCredential) => {
    resolve(userCredential);
  }).catch((error2) => {
    error1.textContent = "Ha ocurrido un error";
    if (error2.code === "auth/invalid-email") {
      error1.textContent = "Correo electr\xF3nico inv\xE1lido";
    } else if (error2.code === "auth/wrong-password") {
      error1.textContent = "La contrase\xF1a es incorrecta. Por favor, intenta de nuevo.";
...
const autenticacion = (email, password) => new Promise((resolve, reject) => {
  createUserWithEmailAndPassword(auth, email, password).then((userCredential) => {
    ...
    if (error2.code === "auth/email-already-in-use") {
      ...
      errorMessage = "Correo electr\xF3nico inv\xE1lido";
...
function home(navigateTo2) {
  ...
  mail.addEventListener("blur", () => {
    ...
    if (!allowedDomains.includes(domain)) {
      error1.textContent = "Por favor, ingrese una direcci\xF3n de correo electr\xF3nico v\xE1lida";
      mail.value = "";
      setTimeout(() => {
        error1.textContent = "";
      }, 3e3);
  ...
  passUser.textContent = "Contrase\xF1a:";
  password.id = "password1";
  password.minLength = 6;
  password.maxLength = 10;
  password.type = "password";
  password.placeholder = "Ingrese contrase\xF1a";
  ...
  showPasswordBtn.addEventListener("click", (e2) => {
    e2.preventDefault();
  ...
  login.textContent = "INICIAR SESI\xD3N";
  mailUser.textContent = "Correo electr\xF3nico:";
  title.textContent = "Patitas.com";
  login.addEventListener("click", (e2) => {
    e2.preventDefault();
    revision(mail.value, password.value, error1).then((user) => {
      navigateTo2("/muro");
      console.log(user);
    }).catch(() => {
      mail.value = "";
  ...
  loginGoogle.textContent = "Inicia sesi\xF3n con Google";
  loginGoogle.setAttribute("id", "loginGoogle-b");
  loginGoogle.addEventListener("click", async (e2) => {
    e2.preventDefault();
    loginGoogle1().then(() => {
      navigateTo2("/muro");
    }).catch((error2) => {
      ...
      if (errorCode === "auth/user-not-found") {
        errorMessage("El usuario no est\xE1 registrado.");
      } else if (errorCode === "auth/wrong-password") {
        errorMessage("La contrase\xF1a no es correcta.");
      } else if (errorCode === "auth/invalid-email") {
        errorMessage("El correo electr\xF3nico no tiene el formato correcto.");
      } else if (errorCode === "auth/credential-already-in-use") {
        errorMessage("Las credenciales ya est\xE1n siendo utilizadas.");
...
const saveTask = async (taskTitle, taskGender, taskAge, taskDescription, owner) => {
  try {
    const docRef = await pf(_h(db, "tasks"), {
      taskTitle,
      taskGender,
      taskAge,
      taskDescription,
...
const getTasks = async () => {
  const querySnapshot = await df(_h(db, "tasks"));
  return querySnapshot;
};
const getTask = async (id2) => {
  try {
    const docRef = gh(db, "tasks", id2);
    const doc = await af(docRef);
    if (doc.exists()) {
      return doc.data();
    }
    ...
    console.error("Error getting document:", e2);
    return null;
  }
};
const onGetTasks = (callback) => {
  const unsub = If(_h(db, "tasks"), callback);
  return unsub;
};
const deleteTask = async (id2) => {
  console.log(id2);
  try {
    await yf(gh(db, "tasks", id2));
    console.log("Document with ID:", id2, "successfully deleted.");
  } catch (e2) {
    console.error("Error deleting document:", e2);
  }
};
const updateTask = async (id2, updateTask2) => {
  try {
    const taskRef = gh(db, "tasks", id2);
    await gf(taskRef, updateTask2);
    console.log("Document with ID:", id2, "successfully updated.");
  } catch (e2) {
    console.error("Error updating document:", e2);
  }
};
const updateLike = (idDoc, idUser) => {
  const taskRef = gh(db, "tasks", idDoc);
  gf(taskRef, { likes: Qf(idUser) });
};
const updateDislike = (idDoc, idUser) => {
  const taskRef = gh(db, "tasks", idDoc);
  gf(taskRef, { likes: jf(idUser) });
};
const submitForm = async (editStatus, id2) => {
...
function muro(navigateTo2) {
  ...
  const title = document.createElement("h1");
  title.textContent = "\u{1F43E} Patitas.com";
  ...
  titleInput.placeholder = "Ingrese un t\xEDtulo";
  ...
  labelFemale.setAttribute = "female-id";
  ...
  labelMale.setAttribute = "male-id";
  ...
  ageLabel.textContent = "Edad (a\xF1os):";
  ...
  descriptionInput.placeholder = "Ingrese la descripci\xF3n";
  ...
  submitBtn.addEventListener("click", (e2) => {
    e2.preventDefault();
  ...
  onGetTasks((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      btnsDelete.forEach((btnDelete) => {
        btnDelete.addEventListener("click", async (e2) => {
          ...
          modalText2.className = "text-modal";
          modalText2.innerText = "\xBFEst\xE1 seguro de que desea eliminar esta publicaci\xF3n?";
          const modalButtons2 = document.createElement("div");
          modalButtons2.classList.add("modal-buttons");
          const confirmButton2 = document.createElement("button");
          confirmButton2.className = "confirm-delete-b";
          confirmButton2.innerText = "Eliminar";
          confirmButton2.addEventListener("click", async () => {
            modal2.style.display = "none";
            await deleteTask(taskId);
          });
          const cancelButton2 = document.createElement("button");
          cancelButton2.innerText = "Cancelar";
          cancelButton2.className = "cancel-delete-b";
          ...
          modalButtons2.appendChild(confirmButton2);
          modalButtons2.appendChild(cancelButton2);
          modalContent2.appendChild(modalText2);
          modalContent2.appendChild(modalButtons2);
  ...
  btnsEdit.forEach((btnEdit) => {
    btnEdit.addEventListener("click", async (e2) => {
      e2.preventDefault();
...
function registro(navigateTo2) {
  ...
  error2.setAttribute("class", "error1");
  error2.textContent = "";
  const mailLabel = document.createElement("label");
  const mail = document.createElement("input");
  mailLabel.textContent = "Correo electr\xF3nico:";
  ...
  mail.addEventListener("blur", () => {
    ...
    const domain = email.split("@")[1];
    if (!allowedDomains.includes(domain)) {
      error2.textContent = "Por favor, ingrese una direcci\xF3n de correo electr\xF3nico v\xE1lida";
      mail.value = "";
      setTimeout(() => {
        error2.textContent = "";
      }, 3e3);
  ...
  const password = document.createElement("input");
  passwordLabel.textContent = "Contrase\xF1a:";
  ...
  register.addEventListener("click", (e2) => {
    e2.preventDefault();
    autenticacion(mail.value, password.value).then((userCredential) => {
      error2.textContent = "El usuario se registr\xF3 con \xE9xito";
